document.addEventListener("DOMContentLoaded", () => {
    const translations = {
        en: {
            ...
            "corporate-process-3-title": "Examinations & Follow-up",
            "corporate-process-3-desc": "Employees receive comfortable exams with native language guidance, and we provide integrated reports and manage follow-ups.",
        ...
        ko: {
            ...
            "corporate-process-3-title": "검진 및 사후관리",
            "corporate-process-3-desc": "직원들은 모국어 안내와 함께 편안한 검진을 받으며, 통합 보고서 제공 및 재검 관리까지 지원합니다.",
        ...
        zh: {
            ...
            "corporate-process-3-title": "体检与后续管理",
            "corporate-process-3-desc": "员工在母语指导下接受舒适的体检，我们提供综合报告并管理后续跟进。",
        ...
        vi: {
            ...
            "corporate-process-3-title": "Khám bệnh & Theo dõi",
            "corporate-process-3-desc": "Nhân viên được khám thoải mái với hướng dẫn bằng tiếng mẹ đẻ, và chúng tôi cung cấp báo cáo tích hợp và quản lý các lần tái khám.",
