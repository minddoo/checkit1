                                ...
                                programs: [
                                    { 
                                        ...
                                        details: {
                                            "선택검사 1 (택 1)": [
                                                "위내시경 (일반 선택 시 수면비 별도)",
                                                "위조영촬영 (위암 및 상부위장관 질환 진단)",
                                                "혈액정밀 (간세포성 간암(AFP), 간세포성 간질환(PIVKA-II), 췌장암(CA19-9))",
                                                "자궁경부암 검사 (HPV DNA 검사 19종)"
                                            ],
                                            "기본 검사": [
                                                "기초검사 (신체계측, 비만도, 체성분, 혈압)",
                                                "시력/청력 (시력/청력 저하 측정)",
                                                "안압/안저 (녹내장, 백내장, 고혈압성 망막변화)",
                                                "폐기능 (폐활량, 환기기능, 기도폐쇄 등)",
                                                "구강검진 (치아 및 치주질환 상태)",
                                                "심전도 (심장부정맥, 심전도 이상 및 심근경색)"
                                            ],
                                            "장비 및 영상 검사": [
