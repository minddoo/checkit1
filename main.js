document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        'ko': {
            ...
            'story-p9': '결과도 받지 못한 채 한국을 떠났습니다. 며칠이 몇 주가 되었습니다. 후속 조치도, 명확한 답변도 없었습니다. 책임감을 느끼는 사람도 아무도 없었습니다.',
            ...
            'refund-title': '환불 정책',
            'refund-non-refundable-title': '환불 불가 상황',
            'refund-non-refundable-desc': '아래 범주에 해당하는 경우 환불이 불가능합니다. 이러한 경우는 저희의 통제 범위를 벗어나며, 병원 자체의 행정 또는 의료 절차 내에서 발생합니다.',
            'refund-nr-li1': '병원 측 문제 (지연, 시스템 오류, 의사 일정 변경, 추가 검사 필요)',
            'refund-nr-li2': '고객의 준비 부족',
            'refund-nr-li3': '고객이 제공된 안내를 따르지 않은 경우',
            'refund-nr-li4': '부정확하거나 불완전한 설문지',
            'refund-nr-li5': '금식 실패 또는 제한된 음식 섭취',
            'refund-nr-li6': '고객의 일정 실수',
            'refund-nr-li7': '병원으로 인한 결과 지연',
            'refund-nr-li8': '고객의 필요 정보 제출 지연',
            'refund-nr-li9': '의료 시스템 내에서 자연적으로 발생 가능한 이벤트 (예상치 못한 업무 흐름 지연, 내부 처리 시간, 병원 프로토콜)',
            'refund-full-refund-title': '전액 환불 상황',
            'refund-full-refund-desc': '실수가 명백히 저희 측에 있는 경우에만 전액 환불이 가능합니다.',
            'refund-fr-li1': '저희가 잘못된 정보(잘못된 날짜, 잘못된 안내, 잘못된 양식)를 제공한 경우',
            'refund-fr-li2': '필수 공지 또는 준비 안내를 보내지 않은 경우',
            'refund-fr-li3': '플랜에 포함된 서류 요청을 누락한 경우',
            'refund-fr-li4': '저희의 오류로 인해 결과가 지연된 경우',
        },
        'en': {
            'logo': 'CHECKIT',
            ...
            'fr-li3': 'We failed to request a document that was included in your plan',            'refund-fr-li4': 'We delayed your results due to our error',
        },
        'zh': {
            'logo': 'CHECKIT',
            ...
            'story-p9': '我没有收到结果就离开了韩国。几天变成了几周。没有跟进。没有明确的答复。没有人感到有责任。',
            ...
            'notice-a1-p2': '是因为定价结构不同。',
            'notice-a2-title': '许多医院的实际情况',
            'notice-a2-p1': '大多数医院会创建单独的“外国人套餐”。这些套餐通常捆绑了当地人不需要付费的服务——这提高了总价格。',
            'notice-a3-title': '我们从外国客户身上看到的普遍情况',
            'notice-a3-p1': '一位客户的外国人套餐报价为1,800,000韩元。在指导下，同样的测试以1,050,000韩元的价格预订。',

            'refund-title': '退款政策',
            'refund-non-refundable-title': '不可退款的情况',
            'refund-non-refundable-desc': '如果您的情况属于以下任何类别，我们无法提供退款。这些事件超出了我们的控制范围，发生在医院自身的行政或医疗流程中。',
            'refund-nr-li1': '医院方面的问题（延误、系统错误、医生日程变更、需要额外检查）',
            'refund-nr-li2': '客户准备不充分',
            'refund-nr-li3': '客户未遵守提供的指示',
            'refund-nr-li4': '问卷不正确或不完整',
            'refund-nr-li5': '禁食失败或食用限制性食物',
            'refund-nr-li6': '客户安排的日程有误',
            'refund-nr-li7': '医院造成的检查结果延迟',
            'refund-nr-li8': '客户延迟提交所需信息',
            'refund-nr-li9': '医疗系统内可能自然发生的事件（意外的工作流程延迟、内部处理时间、医院协议）',
            'refund-full-refund-title': '全额退款的情况',
            'refund-full-refund-desc': '只有在错误明显在我们这边时，才会全额退款。',
            'refund-fr-li1': '我们提供了不正确的信息（错误的日期、错误的说明、错误的表格）',
            'refund-fr-li2': '我们未能发送强制性通知或准备说明',
            'refund-fr-li3': '我们未能申请您计划中包含的文件',
            'refund-fr-li4': '由于我们的错误，我们延迟了您的检查结果',
        },
        'vi': {
            'logo': 'CHECKIT',
            ...
            'story-p9': 'Tôi rời Hàn Quốc mà không nhận được kết quả. Ngày tháng biến thành tuần. Không có sự theo dõi nào. Không có câu trả lời rõ ràng. Không có ai cảm thấy có trách nhiệm.',
            ...
            'notice-subtitle': 'Tại sao người nước ngoài phải trả nhiều tiền hơn cho cùng một lần khám sức khỏe tại Hàn Quốc',
            'notice-q-intro': 'Chúng tôi thường được hỏi câu hỏi này.',
            ...
            'notice-a1-p2': 'Mà là do cấu trúc giá cả.',
            'notice-a2-title': 'Điều gì thực sự xảy ra ở nhiều bệnh viện',
            ...
            'notice-a3-title': 'Một tình huống phổ biến mà chúng tôi thấy ở khách hàng nước ngoài',
            'notice-a3-p1': 'Một khách hàng đã được báo giá 1.800.000 KRW cho một gói dành cho người nước ngoài. Với sự hướng dẫn, các bài kiểm tra tương tự đã được đặt với giá 1.050.000 KRW.',

            'refund-title': 'CHÍNH SÁCH HOÀN TIỀN',
            'refund-non-refundable-title': 'Các trường hợp không được hoàn tiền',
            'refund-non-refundable-desc': 'Chúng tôi không thể hoàn tiền nếu tình huống của bạn thuộc bất kỳ danh mục nào dưới đây. Những sự kiện này nằm ngoài tầm kiểm soát của chúng tôi và xảy ra trong các quy trình hành chính hoặc y tế của riêng bệnh viện.',
            'refund-nr-li1': 'Các vấn đề từ phía bệnh viện (chậm trễ, lỗi hệ thống, thay đổi lịch của bác sĩ, yêu cầu xét nghiệm bổ sung)',
            'refund-nr-li2': 'Sự chuẩn bị không đầy đủ của khách hàng',
            ...
            'refund-nr-li5': 'Không nhịn ăn hoặc tiêu thụ thực phẩm bị hạn chế',
            'refund-nr-li6': 'Khách hàng sắp xếp lịch trình sai',
            'refund-nr-li7': 'Kết quả chậm trễ do bệnh viện gây ra',
