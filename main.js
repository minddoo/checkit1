document.addEventListener('DOMContentLoaded', () => {
    const translations = {
        'ko': {
            'nav-services': '서비스', 'nav-process': '프로세스', 'nav-testimonials': '후기', 'nav-contact': '문의', 'nav-pricing': '서비스 플랜',
            'logo': 'CHECKIT',
            ...
            'plan-lite-title': 'LITE', 'plan-lite-price': '₩119,000',
            'plan-standard-title': 'STANDARD', 'plan-standard-price': '₩219,000',
            'plan-premium-title': 'PREMIUM', 'plan-premium-price': '₩259,000',
            'plan-popular-badge': '가장 인기있는 플랜',
            'feature-consulting': '맞춤 컨설팅', 'feature-booking': '예약 대행', 'feature-pre-guidance': '사전 안내', 'feature-translation': '결과지 번역', 'feature-comm-service': '커뮤니케이션 서비스', 'feature-post-guidance': '사후 안내',
            'plan-cta': '상담 신청',
            'process-title': 'CHECKIT 이용 과정', 'process-1-title': '온라인 상담 신청', 'process-1-desc': '웹사이트를 통해 간단히 상담을 신청하고, 전담 매니저가 배정됩니다.', 'process-2-title': '맞춤 컨설팅 및 예약 보조', 'process-2-desc': '필요한 검진, 일정, 언어를 조율하고 최종 예약을 확정합니다.', 'process-3-title': '검진 및 결과 안내', 'process-3-desc': '예약된 날짜에 편안하게 검진을 받고, 번역된 결과지와 후속 안내까지 한번에 제공받습니다.',
            'testimonials-title': '사용자 후기', 'testimonial-1-text': '“정말 최고의 서비스였습니다. 예약부터 통역까지 완벽하게 도와주셔서 정말 편안하게 건강검진을 마칠 수 있었습니다.”', 'testimonial-2-text': '“한국 병원 방문이 처음이라 막막했는데, CHECKIT 덕분에 모든 것이 순조로웠습니다. 강력히 추천합니다!”',
            ...
            'chat-title': 'CHECKIT봇', 'chat-welcome': '안녕하세요! CHECKIT봇입니다. 아래 목록에서 궁금한 점을 선택하거나, 간단한 인사를 나눠보세요.', 'chat-input-placeholder': '메시지를 입력하세요...',
        },
        'en': {
            'nav-services': 'Services', 'nav-process': 'Process', 'nav-testimonials': 'Testimonials', 'nav-contact': 'Contact', 'nav-pricing': 'Service Plans',
            'logo': 'CHECKIT',
            ...
            'view-plans-cta': 'Find My Plan',
            'individuals-title': 'For Individuals', 'individuals-desc': 'Experience a personalized health check-up journey. Services for residents in Korea and medical tourists.', 'individuals-cta': 'Learn More',
            'business-title': 'For Business', 'business-desc': 'Systematically manage the health of your foreign employees to prevent industrial accidents and increase work efficiency.', 'business-cta': 'Learn More',
            ...
            'feature-consulting': 'Custom Consulting', 'feature-booking': 'Booking Agency', 'feature-pre-guidance': 'Pre-checkup Guidance', 'feature-translation': 'Result Translation', 'feature-comm-service': 'Communication Service', 'feature-post-guidance': 'Post-checkup Guidance',
            ...
            'testimonials-title': 'User Reviews', 'testimonial-1-text': '"This was truly the best service. They helped me perfectly from booking to interpretation, so I could complete my health checkup very comfortably."', 'testimonial-2-text': '"It was my first time visiting a hospital in Korea and I was lost, but thanks to CHECKIT, everything went smoothly. I highly recommend it!"',
            ...
            'footer-copy': '© 2024 CHECKIT. All rights reserved.',
            'chat-title': 'CHECKIT Bot', 'chat-welcome': 'Hello! I\'m CHECKIT Bot. Please select a question from the list below, or say a simple greeting.', 'chat-input-placeholder': 'Type your message...',
        },
        'zh': {
            'nav-services': '服务', 'nav-process': '过程', 'nav-testimonials': '评价', 'nav-contact': '询问', 'nav-pricing': '服务计划',
            'logo': 'CHECKIT',
            'hero-title': '为外国人提供健康体检，<br>无语言障碍，舒心体验。',
            'hero-subtitle': '从错过预约、难以理解的体检指南，到仅提供韩语版本的结果报告，CHECKIT为您解决所有非医疗过程中的难题。',
            'hero-cta': '立即申请咨询',
            'view-plans-cta': '寻找适合我的计划',
            'individuals-title': '个人客户', 'individuals-desc': '体验个性化的健康检查之旅。为韩国居民和医疗游客提供服务。', 'individuals-cta': '了解更多',
            'business-title': '企业客户', 'business-desc': '系统地管理外籍员工的健康，以预防工业事故并提高工作效率。', 'business-cta': '了解更多',
            ...
            'feature-consulting': '定制咨询', 'feature-booking': '预约代理', 'feature-pre-guidance': '事前指南', 'feature-translation': '结果翻译', 'feature-comm-service': '沟通服务', 'feature-post-guidance': '事后指南',
            'plan-cta': '开始咨询',
            'process-title': 'CHECKIT 使用流程', 'process-1-title': '在线申请咨询', 'process-1-desc': '通过网站简单申请咨询，我们将为您分配专属经理。', 'process-2-title': '定制咨询及预约协助', 'process-2-desc': '协调必要的检查、日程和语言，并确定最终预约。', 'process-3-title': '体检及结果指南', 'process-3-desc': '在预定日期轻松接受体检，并一次性收到翻译好的结果报告和后续指南。',
            'testimonials-title': '用户评价', 'testimonial-1-text': '“这真的是最棒的服务。从预约到口译，他们都完美地帮助了我，让我非常舒适地完成了健康体检。”', 'testimonial-2-text': '“这是我第一次来韩国的医院，感到很迷茫，但多亏了CHECKIT，一切都进行得很顺利。我强烈推荐！”',
            ...
            'chat-title': 'CHECKIT 机器人', 'chat-welcome': '你好！我是CHECKIT机器人。请从下面的列表中选择一个问题，或者说一句简单的问候。', 'chat-input-placeholder': '输入您的留言...',
        },
        'vi': {
            'nav-services': 'Dịch vụ', 'nav-process': 'Quy trình', 'nav-testimonials': 'Đánh giá', 'nav-contact': 'Liên hệ', 'nav-pricing': 'Gói dịch vụ',
            'logo': 'CHECKIT',
            ...
            'view-plans-cta': 'Tìm gói phù hợp với tôi',
            'individuals-title': 'Dành cho cá nhân', 'individuals-desc': 'Trải nghiệm hành trình kiểm tra sức khỏe được cá nhân hóa. Dịch vụ dành cho người cư trú tại Hàn Quốc và khách du lịch y tế.', 'individuals-cta': 'Tìm hiểu thêm',
            'business-title': 'Dành cho doanh nghiệp', 'business-desc': 'Quản lý sức khỏe của nhân viên nước ngoài một cách có hệ thống để ngăn ngừa tai nạn lao động và tăng hiệu quả công việc.', 'business-cta': 'Tìm hiểu thêm',
            ...
            'pricing-title': 'Chọn gói hoàn hảo cho bạn',
            'plan-lite-title': 'LITE', 'plan-lite-price': '₩119,000',
            'plan-standard-title': 'STANDARD', 'plan-standard-price': '₩219,000',
            'plan-premium-title': 'PREMIUM', 'plan-premium-price': '₩259,000',
            'plan-popular-badge': 'Phổ biến nhất',
            'feature-consulting': 'Tư vấn tùy chỉnh', 'feature-booking': 'Đại lý đặt lịch', 'feature-pre-guidance': 'Hướng dẫn trước khi khám', 'feature-translation': 'Dịch kết quả', 'feature-comm-service': 'Dịch vụ giao tiếp', 'feature-post-guidance': 'Hướng dẫn sau khi khám',
            'plan-cta': 'Bắt đầu',
            ...
            'testimonials-title': 'Đánh giá của người dùng', 'testimonial-1-text': '"Đây thực sự là dịch vụ tốt nhất. Họ đã giúp tôi một cách hoàn hảo từ việc đặt lịch đến phiên dịch, vì vậy tôi có thể hoàn thành việc khám sức khỏe của mình một cách rất thoải mái."', 'testimonial-2-text': '"Đây là lần đầu tiên tôi đến bệnh viện ở Hàn Quốc và tôi đã bị lạc lõng, nhưng nhờ có CHECKIT, mọi thứ đã diễn ra suôn sẻ. Tôi rất muốn giới thiệu nó!"',
            ...
            'chat-title': 'CHECKIT Bot', 'chat-welcome': 'Xin chào! Tôi là CHECKIT Bot. Vui lòng chọn một câu hỏi từ danh sách dưới đây, hoặc nói một lời chào đơn giản.', 'chat-input-placeholder': 'Nhập tin nhắn của bạn...',
        }
    };
    ...
    function updateTexts(lang) {
        ...
        currentLang = lang;
        if (typeof updateFaqButtons === 'function') {
