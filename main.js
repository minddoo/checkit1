...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        'ko': {
            'logo': 'CHECKIT',
            'nav-reality': '현실', 'nav-services': '솔루션', 'nav-contact': '문의',
            ...
            'option4-title': '프로그램 & 사후관리 구조 팩', 'option4-desc': '검사 항목, 결과 구조 및 검사 후 관리에 대한 비의료적 가이드입니다.',
        ...
        'en': {
            ...
            'option4-title': 'Program & Aftercare Structure Pack', 'option4-desc': 'A non-medical guide explaining your exam conditions, result structure, and post-exam care.',
        ...
        'zh': {
            'logo': 'CHECKIT',
            'nav-reality': '现实', 'nav-services': '解决方案', 'nav-contact': '联系我们',
            ...
            'option4-title': '项目和后续护理结构包', 'option4-desc': '解释您的检查条件、结果结构和检查后护理的非医疗指南。',
        ...
        'vi': {
            ...
            'option4-title': 'Gói cấu trúc chương trình & chăm sóc sau', 'option4-desc': 'Một hướng dẫn phi y tế giải thích các điều kiện khám, cấu trúc kết quả và chăm sóc sau khám của bạn.',
