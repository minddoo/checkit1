document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'why_us_feature1_desc': '엑셀 명단 업로드 한 번으로<br>수백 명 근로자의 검진 현황을<br>실시간으로 즉시 확인하세요.',
            'why_us_feature2_title': '1:1 모국어 전담 매니저 매칭',
            'why_us_feature2_desc': '전담 매니저가 근로자와 1:1로<br>직접 소통하여 예약부터 행정까지<br>모든 과정을 밀착 관리합니다.',
            'why_us_feature3_title': '모국어 결과지 번역 및 데이터화',
            'why_us_feature3_desc': '한국어 결과지를 모국어로 번역해<br>근로자의 알 권리를 충실히 보장하고<br>표준화된 건강 지표를 보고합니다.',
            'why_us_feature4_title': '법적 리스크 및 OHS 완벽 대응',
            'why_us_feature4_desc': '산업안전보건법을 엄격히 준수하며<br>검진 누락 방지와 사후 관리를 통해<br>기업의 법적 책임을 지원합니다.',
