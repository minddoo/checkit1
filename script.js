document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'individual_page_title': '개인 고객 맞춤 서비스', 'individual_page_subtitle': 'CHECKIT은 한국에 거주하거나 방문하는 모든 외국인 개인이\n언어의 장벽 없이 최상의 건강검진을 받을 수 있도록 돕습니다.',
            'solution_title': 'CHECKIT의 솔루션', 'solution_subtitle': '불편함, 외로움, 불안함 없이 건강검진의 전 과정에 온전히 집중할 수 있도록 CHECKIT이 함께합니다.',
            ...
            'expectation_item_title_1': '#1. 비용 효율성', 'expectation_item_desc_1': '“미국에 비해 한국의 의료비가 훨씬 저렴하다는 것은 잘 알려져 있습니다.”', 'expectation_item_title_2': '#2. 편리함', 'expectation_item_desc_2': '“전체 과정이 간단하고 번거로움 없이 진행될 것으로 기대됩니다.”', 'expectation_item_title_3': '#3. 전문적인 수준', 'expectation_item_desc_3': '“시설과 의료 수준이 세계적일 것으로 기대됩니다.”', 'expectation_item_title_4': '#4. 시간 절약', 'expectation_item_desc_4': '“일정에 거의 영향을 주지 않고 신속하게 진행될 것으로 기대됩니다.”',
            'reality_title': '하지만 현실은...',
            'reality_item_title_1': '영어 지원 부재',
            'reality_item_1_point_1': '직원들은 영어를 못해서 전화를 피합니다.',
            ...
            'chatbot_header': 'Check봇','chatbot_placeholder': '메시지를 입력하세요...','chatbot_greeting': '안녕하세요! CHECKIT에 대해 궁금한 점이 있으신가요? 아래에서 질문을 선택하거나 직접 입력해주세요.','greeting_response': '안녕하세요! 만나서 반가워요. CHECKIT에 대해 궁금한 점이 있으시면 아래 질문을 선택하거나 직접 물어보세요.','q1': '예약은 어떻게 하나요?','a1': 'CHECKIT 전담 매니저가 도와드립니다. 원하시는 검진 항목과 일정을 알려주시면, 조건에 맞는 병원 목록을 전달드려 선택을 돕고, 예약까지 한 번에 진행해드립니다. \'지금 바로 상담 신청\' 버튼을 눌러 문의를 남겨주세요!','q2': '병원/의료인과 계약된 구조인가요?','a2': '아닙니다. CHECKIT은 특정 병원과 계약 관계를 맺지 않습니다. 저희는 오직 고객님의 입장에서, 가장 적합한 병원을 찾으실 수 있도록 객관적인 정보 제공으로 선택을 돕습니다. 고객님의 건강과 만족이 저희의 최우선 목표입니다.','q3': '의료 행위나 진료 알선을 하나요?','a3': '아니요, CHECKIT은 의료법을 준수하며 어떠한 의료 행위나 진료 알선도 하지 않습니다. 저희는 병원 예약, 통역, 결과지 번역 등 \'비의료 과정\'에 집중하여 고객님께서 건강검진에만 집중하실 수 있도록 돕는 서비스입니다.','q4': '검진 당일 어떤 도움을 받을 수 있나요?','a4': '검진 당일, 언어의 장벽으로 인해 혼자라는 느낌이 들지 않도록 Check봇 매니저가 모든 순간을 함께합니다. 병원 내 접수, 문진, 수납 등 모든 의사소통 과정을 실시간으로 지원하여, 언어 문제로 인한 불편함이나 외로움 없이 편안하게 검진에만 집중하실 수 있도록 돕습니다.','q5': '결과지는 어떻게 전달되나요?','a5': '고객님께서 병원으로부터 수령한 한국어 결과지를 전달해주시면, 저희가 고객님의 모국어로 핵심 내용을 단순 번역 및 요약하여 전달해 드립니다. 저희는 의료법을 준수하기에, 의학적 소견이나 상세한 설명은 제공하지 않습니다.','unsupported_input': '흥미로운 질문이네요! 현재는 정해진 답변만 드릴 수 있지만, 더 자세한 내용은 \'상담 신청\'을 통해 문의하시면, 전문 매니저가 친절하게 안내해 드릴 거예요.'
        },
        en: {
            'nav_home': 'Home',
            ...
            'individual_page_title': 'Personalized Services\nfor Individual Clients',
            'individual_page_subtitle': 'CHECKIT helps all foreign individuals residing in or visiting Korea\nreceive the best health check-ups without language barriers.',
            'solution_title': 'CHECKIT\'s Solution', 'solution_subtitle': 'CHECKIT is with you throughout the entire health check-up process, ensuring you can focus solely on your health without any inconvenience, loneliness, or anxiety.',
            ...
            'expectation_item_title_1': '#1. Cost Efficiency', 'expectation_item_desc_1': '“Medical care in Korea is known to be dramatically cheaper than in the U.S.”', 'expectation_item_title_2': '#2. Convenience', 'expectation_item_desc_2': '“The entire process is expected to be simple and hassle-free.”', 'expectation_item_title_3': '#3. Professional Quality', 'expectation_item_desc_3': '“Facilities and medical standards are expected to be world-class.”', 'expectation_item_title_4': '#4. Time Safety', 'expectation_item_desc_4': '“It\'s expected to be quick, with minimal impact on your schedule.”',
            ...
            'chatbot_header': 'Check Bot','chatbot_placeholder': 'Type a message...','chatbot_greeting': 'Hello! Do you have any questions about CHECKIT? Please select a question below or type your own.','greeting_response': 'Hello! Nice to meet you. If you have any questions about CHECKIT, feel free to select a question below or ask me directly.','q1': 'How do I make a reservation?','a1': 'Your dedicated CHECKIT manager will assist you. Just tell us your desired check-up items and schedule, and we will provide a list of hospitals that fit your criteria to help you choose, and then handle the reservation for you. Click the \'Apply for a Consultation Now\' button to leave an inquiry!','q2': 'Are you contracted with hospitals/medical staff?','a2': 'No. CHECKIT does not have contractual relationships with any specific hospitals. We help you choose the most suitable hospital by providing objective information from your perspective. Your health and satisfaction are our top priorities.','q3': 'Do you perform medical acts or arrange treatments?','a3': 'No, CHECKIT complies with the Medical Service Act and does not perform any medical acts or arrange treatments. We are a service that helps you focus solely on your health check-up by concentrating on \'non-medical processes\' such as hospital reservations, interpretation, and result translation.','q4': 'What kind of help can I get on the day of the check-up?','a4': 'On the day of your check-up, your Check Bot manager is with you every step of the way so you don\'t feel alone due to language barriers. We provide real-time support for all communication processes within the hospital, such as registration, consultations, and payment, helping you focus comfortably on your check-up without inconvenience or loneliness caused by language issues.','q5': 'How are the results delivered?','a5': 'Once you provide us with the Korean results you received from the hospital, we will provide a simple translation and summary of the key contents in your native language. To comply with medical law, we do not provide medical opinions or detailed explanations.','unsupported_input': 'That\'s an interesting question! I can only provide pre-set answers for now, but if you inquire through \'Apply for a Consultation\', a professional manager will kindly guide you.'
        },
        cn: {
            'nav_home': '首页',
            ...
            'individual_page_title': '个人客户专属服务', 'individual_page_subtitle': 'CHECKIT 帮助所有居住或访问韩国的外国个人\n无语言障碍地获得最佳的健康体检服务。',
            'solution_title': 'CHECKIT的解决方案', 'solution_subtitle': 'CHECKIT 伴随您完成整个体检过程，确保您可以完全专注于自己的健康，没有任何不便、孤独或焦虑。',
            ...
            'expectation_title': '外国人期待的韩国医疗服务', 'expectation_subtitle': '“要不要在韩国做个健康体检？”<br>海外社区经常提到的韩国医疗特点', 'expectation_item_title_1': '#1. 成本效益', 'expectation_item_desc_1': '“众所周知，韩国的医疗费用比美国便宜得多。”', 'expectation_item_title_2': '#2. 便利性', 'expectation_item_desc_2': '“整个过程预计将是简单且无忧的。”', 'expectation_item_title_3': '#3. 专业品质', 'expectation_item_desc_3': '“设施和医疗标准有望达到世界一流水平。”', 'expectation_item_title_4': '#4. 时间安全', 'expectation_item_desc_4': '“预计会很快，对您的日程安排影响最小。”',
            'reality_title': '但现实是...',
            ...
            'chatbot_header': 'Check Bot','chatbot_placeholder': '输入消息...','chatbot_greeting': '您好！对CHECKIT有什么疑问吗？请从下方选择问题或直接输入。','greeting_response': '您好！很高兴见到您。如果您对CHECKIT有任何疑问，请随时从下方选择问题或直接提问。','q1': '如何预约？','a1': 'CHECKIT的专属经理将为您提供帮助。只需告诉我们您想要的检查项目和日程，我们将提供符合您条件的医院列表以帮助您选择，并一次性为您完成预约。请点击\'立即申请咨询\'按钮留下您的问题！','q2': '是否与医院/医务人员签订了合同？','a2': '不是的。CHECKIT不与任何特定医院签订合同。我们完全从您的立场出发，通过提供客观信息来帮助您选择最合适的医院。您的健康和满意是我们的首要目标。','q3': '你们是否提供医疗行为或安排治疗？','a3': '不，CHECKIT遵守医疗服务法，不进行任何医疗行为或安排治疗。我们是一项专注于\'非医疗过程\'的服务，如医院预约、口译和结果翻译，以帮助您专注于您的健康检查。','q4': '体检当天能得到什么帮助？','a4': '体检当天，Check Bot经理将全程陪伴您，让您不会因为语言障碍而感到孤单。我们为医院内的所有沟通环节（如挂号、问诊、缴费等）提供实时支持，帮助您舒适地专注于体检，而不会因语言问题感到不便或孤独。','q5': '结果如何传递？','a5': '当您向我们提供您从医院收到的韩文结果报告后,我们将以您的母语提供核心内容的简单翻译和摘要。为遵守医疗法,我们不提供医疗意见或详细解释。','unsupported_input': '这是一个有趣的问题！目前我只能提供预设的答案，但如果您通过“申请咨询”进行查询，专业的经理会亲切地为您引导。'
        },
        vn: {
            'nav_home': 'Trang chủ',
            ...
            'individual_page_title': 'Dịch vụ Cá nhân hóa\ncho Khách hàng Cá nhân',
            'individual_page_subtitle': 'CHECKIT giúp mọi cá nhân nước ngoài đang cư trú hoặc đến thăm Hàn Quốc\nđược khám sức khỏe tốt nhất mà không gặp rào cản ngôn ngữ.',
            'solution_title': 'Giải pháp của CHECKIT', 'solution_subtitle': 'CHECKIT đồng hành cùng bạn trong suốt quá trình khám sức khỏe, đảm bảo bạn có thể hoàn toàn tập trung vào sức khỏe của mình mà không gặp bất kỳ sự bất tiện, cô đơn hay lo lắng nào.',
            ...
            'expectation_title': 'Dịch vụ Y tế Hàn Quốc mà Người nước ngoài Mong đợi', 'expectation_subtitle': '"Tôi có nên đi khám sức khỏe ở Hàn Quốc không?"<br>Những đặc điểm của y tế Hàn Quốc thường được nhắc đến trong các cộng đồng nước ngoài', 'expectation_item_title_1': '#1. Hiệu quả về chi phí', 'expectation_item_desc_1': '“Chi phí chăm sóc y tế ở Hàn Quốc được biết là rẻ hơn đáng kể so với ở Mỹ.”', 'expectation_item_title_2': '#2. Sự tiện lợi', 'expectation_item_desc_2': '“Toàn bộ quy trình dự kiến sẽ đơn giản và không phức tạp.”', 'expectation_item_title_3': '#3. Chất lượng chuyên nghiệp', 'expectation_item_desc_3': '“Các cơ sở vật chất và tiêu chuẩn y tế được kỳ vọng sẽ đạt đẳng cấp thế giới.”', 'expectation_item_title_4': '#4. An toàn về thời gian', 'expectation_item_desc_4': '“Nó được mong đợi là nhanh chóng, với tác động tối thiểu đến lịch trình của bạn.”',
            ...
            'chatbot_header': 'Check Bot','chatbot_placeholder': 'Nhập tin nhắn...','chatbot_greeting': 'Xin chào! Bạn có câu hỏi nào về CHECKIT không? Vui lòng chọn một câu hỏi dưới đây hoặc tự nhập câu hỏi của bạn.','greeting_response': 'Xin chào! Rất vui được gặp bạn. Nếu bạn có bất kỳ câu hỏi nào về CHECKIT, hãy chọn một câu hỏi dưới đây hoặc hỏi trực tiếp.','q1': 'Làm cách nào để đặt lịch hẹn?','a1': 'Quản lý CHECKIT tận tâm của bạn sẽ hỗ trợ bạn. Chỉ cần cho chúng tôi biết các mục khám và lịch trình mong muốn của bạn, chúng tôi sẽ cung cấp danh sách các bệnh viện phù hợp với tiêu chí của bạn để giúp bạn lựa chọn và xử lý việc đặt lịch hẹn cho bạn. Nhấp vào nút \'Đăng ký tư vấn ngay\' để để lại yêu cầu!','q2': 'Bạn có hợp đồng với bệnh viện/nhân viên y tế không?','a2': 'Không. CHECKIT không có mối quan hệ hợp đồng với bất kỳ bệnh viện cụ thể nào. Chúng tôi giúp bạn chọn bệnh viện phù hợp nhất một cách khách quan bằng cách cung cấp thông tin từ góc độ của bạn. Sức khỏe và sự hài lòng của bạn là ưu tiên hàng đầu của chúng tôi.','q3': 'Bạn có thực hiện các hành vi y tế hoặc sắp xếp các phương pháp điều trị không?','a3': 'Không, CHECKIT tuân thủ Đạo luật Dịch vụ Y tế và không thực hiện bất kỳ hành vi y tế hoặc sắp xếp phương pháp điều trị nào. Chúng tôi là một dịch vụ giúp bạn chỉ tập trung vào việc kiểm tra sức khỏe bằng cách tập trung vào các \'quy trình phi y tế\' như đặt lịch hẹn bệnh viện, phiên dịch và dịch kết quả.','q4': 'Tôi có thể nhận được sự giúp đỡ gì vào ngày khám?','a4': 'Vào ngày khám, quản lý của Check Bot sẽ đồng hành cùng bạn trong mọi khoảnh khắc để bạn không cảm thấy đơn độc vì rào cản ngôn ngữ. Chúng tôi hỗ trợ thời gian thực cho tất cả các quy trình giao tiếp trong bệnh viện như đăng ký, tư vấn và thanh toán, giúp bạn thoải mái tập trung vào việc khám sức khỏe mà không gặp phải sự bất tiện hay cô đơn do vấn đề ngôn ngữ.','q5': 'Kết quả được gửi như thế nào?','a5': 'Sau khi bạn cung cấp cho chúng tôi kết quả bằng tiếng Hàn mà bạn nhận được từ bệnh viện, chúng tôi sẽ cung cấp một bản dịch và tóm tắt đơn giản về nội dung chính bằng tiếng mẹ đẻ của bạn. Để tuân thủ luật y tế, chúng tôi không cung cấp ý kiến y tế hoặc giải thích chi tiết.','unsupported_input': 'Đó là một câu hỏi thú vị! Hiện tại tôi chỉ có thể cung cấp các câu trả lời được cài sẵn, nhưng nếu bạn yêu cầu thông qua \'Đăng ký tư vấn\', một người quản lý chuyên nghiệp sẽ vui lòng hướng dẫn bạn.'
        }
    };
