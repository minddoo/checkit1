document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'individual_desc': '한국 거주/방문 외국인 개인이 언어 장벽 없이\n편안하게 건강검진을 받을 수 있도록 지원합니다.',
            'corporate_title': '기업 고객',
            'corporate_desc': '외국인 근로자의 단체 건강검진을 쉽고 효율적으로 관리하여,\n기업의 보건 관리 부담을 줄여드립니다.',
            'learn_more': '더 알아보기',
            'why_us_title': '왜 CHECKIT을 선택해야 할까요?',
            'why_us_subtitle_new': '의료 서비스의 높은 질에도 불구하고, 외국인들은 예약, 접수, 결과 확인 등 \'비의료 과정\'에서 어려움을 겪습니다.\nCHECKIT은 바로 이 공백을 채웁니다.',
            ...
            'individual_page_subtitle': 'CHECKIT은 한국에 거주하거나 방문하는 모든 외국인 개인이\n언어의 장벽 없이 최상의 건강검진을 받을 수 있도록 돕습니다.',
            ...
            'options_title': '옵션 서비스',
            'option1_title': '프로그램 & 사후관리 팩',
            'option1_price': '₩82,800',
            'option1_desc': '검사 항목, 결과 구조 및 검사 후 관리에 대한 비의료적 가이드입니다.',
            'option2_title': '그래픽 동선 가이드',
            'option2_price': '₩27,600',
            'option2_desc': '정확한 병원 내 동선과 이동 흐름을 보여줍니다. 첫 방문객에게 유용합니다.',
            'option3_title': '일정 변경',
            'option3_desc': '예약 후 예약을 변경해야 하는 고객을 위한 옵션입니다.',
            'option3_item1': '1회 변경: ₩34,500',
            'option3_item2': '2회 패키지: ₩55,200',
            'option3_item3': '무제한 변경: ₩276,000',
            'option4_title': '영문 영수증 요청',
            'option4_price': '₩27,600',
            'option4_desc': '보험 목적에 적합한 영문 영수증을 대신 요청합니다.',
            'option5_title': 'CD 결과 요청',
            'option5_price': '₩27,600',
            'option5_desc': '검사 CD 또는 추가 영상 파일을 대신 요청합니다.',
            'option6_title': '긴급 결과 후속 조치',
            'option6_price': '₩27,600',
            'option6_desc': '병원에 긴급 후속 조치 메시지를 한 번 보냅니다.',
        ...
        en: {
            ...
            'hero_subtitle': 'From missed schedules and difficult-to-understand check-up guides to results provided only in Korean.\nCHECKIT solves all non-medical processes.',
            'hero_cta': 'Apply for a Consultation Now',
            'service_for_title': 'Who is this service for?',
            'individual_title': 'Individual Clients',
            'individual_desc': 'We support foreign individuals residing in or visiting Korea to receive health check-ups comfortably\nwithout language barriers.',
            'corporate_title': 'Corporate Clients',
            'corporate_desc': 'We manage group health check-ups for foreign employees easily and efficiently,\nreducing the burden of corporate health care.',
            'learn_more': 'Learn More',
            'why_us_title': 'Why Choose CHECKIT?',
            'why_us_subtitle_new': 'Despite the high quality of medical services, foreigners face difficulties in \'non-medical processes\' such as booking, registration, and result checking.\nCHECKIT fills this very gap.',
            ...
            'options_title': 'Optional Services',
            'option1_title': 'Program & Aftercare Pack',
            'option1_price': '₩82,800',
            'option1_desc': 'A non-medical guide to test items, result structure, and post-test management.',
            'option2_title': 'Graphic Route Guide',
            'option2_price': '₩27,600',
            'option2_desc': 'Shows the exact route and flow of movement within the hospital. Useful for first-time visitors.',
            'option3_title': 'Schedule Change',
            'option3_desc': 'This option is for customers who need to change their reservation after it has been made.',
            'option3_item1': '1 Change: ₩34,500',
            'option3_item2': '2-Change Package: ₩55,200',
            'option3_item3': 'Unlimited Changes: ₩276,000',
            'option4_title': 'Request for English Receipt',
            'option4_price': '₩27,600',
            'option4_desc': 'We request an English receipt suitable for insurance purposes on your behalf.',
            'option5_title': 'Request for CD Results',
            'option5_price': '₩27,600',
            'option5_desc': 'We request the test CD or additional image files on your behalf.',
            'option6_title': 'Urgent Result Follow-up',
            'option6_price': '₩27,600',
            'option6_desc': 'We send one urgent follow-up message to the hospital.',
        ...
        cn: {
            ...
            'hero_subtitle': '从错过日程、难以理解的体检指南，到仅提供韩语版本的结果报告。\nCHECKIT为您解决所有非医疗过程中的难题。',
            'hero_cta': '立即申请咨询',
            'service_for_title': '这项服务是为谁准备的？',
            'individual_title': '个人客户',
            'individual_desc': '我们帮助居住或访问韩国的外国个人无语言障碍地\n舒适接受健康体检。',
            'corporate_title': '企业客户',
            'corporate_desc': '我们轻松高效地管理外国员工的团体健康体检，\n减轻企业保健管理的负担。',
            'learn_more': '了解更多',
            'why_us_title': '为什么选择CHECKIT？',
            'why_us_subtitle_new': '尽管医疗服务质量很高，但外国人在预约、登记、确认结果等“非医疗过程”中仍面临困难。\nCHECKIT正是填补了这一空白。',
            ...
            'individual_page_subtitle': 'CHECKIT 帮助所有居住或访问韩国的外国个人\n无语言障碍地获得最佳的健康体检服务。',
            ...
            'options_title': '可选服务',
            'option1_title': '项目和售后管理包',
            'option1_price': '₩82,800',
            'option1_desc': '关于检查项目、结果结构和检查后管理的非医疗指南。',
            'option2_title': '图形路线指南',
            'option2_price': '₩27,600',
            'option2_desc': '显示医院内的确切路线和移动流程。对初次访客很有用。',
            'option3_title': '日程变更',
            'option3_desc': '此选项适用于需要在预订后更改预订的客户。',
            'option3_item1': '更改1次：₩34,500',
            'option3_item2': '2次更改套餐：₩55,200',
            'option3_item3': '无限次更改：₩276,000',
            'option4_title': '要求提供英文收据',
            'option4_price': '₩27,600',
            'option4_desc': '我们代表您申请适合保险用途的英文收据。',
            'option5_title': '要求提供CD结果',
            'option5_price': '₩27,600',
            'option5_desc': '我们代表您申请检查CD或其他图像文件。',
            'option6_title': '紧急结果跟进',
            'option6_price': '₩27,600',
            'option6_desc': '我们向医院发送一条紧急跟进信息。',
            'chatbot_header': 'Check Bot',
        ...
        vn: {
            ...
            'hero_subtitle': 'Từ lịch trình bị bỏ lỡ, hướng dẫn khám khó hiểu, đến kết quả chỉ có bằng tiếng Hàn.\nCHECKIT giải quyết mọi quy trình phi y tế.',
            'hero_cta': 'Đăng ký tư vấn ngay',
            'service_for_title': 'Dịch vụ này dành cho ai?',
            'individual_title': 'Khách hàng cá nhân',
            'individual_desc': 'Chúng tôi hỗ trợ người nước ngoài cư trú hoặc đến thăm Hàn Quốc nhận khám sức khỏe một cách thoải mái\nmà không có rào cản ngôn ngữ.',
            'corporate_title': 'Khách hàng doanh nghiệp',
            'corporate_desc': 'Chúng tôi quản lý các cuộc khám sức khỏe nhóm cho nhân viên nước ngoài một cách dễ dàng và hiệu quả,\ngiảm bớt gánh nặng quản lý chăm sóc sức khỏe của doanh nghiệp.',
            'learn_more': 'Tìm hiểu thêm',
            'why_us_title': 'Tại sao chọn CHECKIT?',
            'why_us_subtitle_new': 'Mặc dù chất lượng dịch vụ y tế cao, người nước ngoài vẫn gặp khó khăn trong các “quy trình phi y tế” như đặt hẹn, đăng ký và kiểm tra kết quả.\nCHECKIT lấp đầy khoảng trống này.',
            ...
            'options_title': 'Dịch vụ tùy chọn',
            'option1_title': 'Gói chương trình & chăm sóc sau',
            'option1_price': '₩82,800',
            'option1_desc': 'Hướng dẫn phi y tế về các hạng mục xét nghiệm, cấu trúc kết quả và quản lý sau xét nghiệm.',
            'option2_title': 'Hướng dẫn tuyến đường bằng đồ họa',
            'option2_price': '₩27,600',
            'option2_desc': 'Hiển thị tuyến đường và luồng di chuyển chính xác trong bệnh viện. Hữu ích cho khách truy cập lần đầu.',
            'option3_title': 'Thay đổi lịch trình',
            'option3_desc': 'Tùy chọn này dành cho những khách hàng cần thay đổi đặt chỗ sau khi đã thực hiện.',
            'option3_item1': '1 lần thay đổi: ₩34,500',
            'option3_item2': 'Gói 2 lần thay đổi: ₩55,200',
            'option3_item3': 'Thay đổi không giới hạn: ₩276,000',
            'option4_title': 'Yêu cầu hóa đơn tiếng Anh',
            'option4_price': '₩27,600',
            'option4_desc': 'Chúng tôi thay mặt bạn yêu cầu hóa đơn tiếng Anh phù hợp cho mục đích bảo hiểm.',
            'option5_title': 'Yêu cầu kết quả CD',
            'option5_price': '₩27,600',
            'option5_desc': 'Chúng tôi thay mặt bạn yêu cầu CD xét nghiệm hoặc các tệp hình ảnh bổ sung.',
            'option6_title': 'Theo dõi kết quả khẩn cấp',
            'option6_price': '₩27,600',
            'option6_desc': 'Chúng tôi gửi một tin nhắn theo dõi khẩn cấp đến bệnh viện.',
            'chatbot_header': 'Check Bot',
