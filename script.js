document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        cn: {
            ...
            'corp_sec5_subtitle': '我们以无可比拟의专业性和技术力树立外国员工管理的标准.',
            ...
            'corp_sec6_item3_desc': '无需复杂的系统对接，只需申请服务，从明天起即可改善外国员工의体检环境.',
            ...
            'greeting_response': '您好！很高興见到您. 如果您对CHECKIT有任何疑问，请随时从下方选择问题 or 直接提문.',
            'q1': '如何预约？',
        ...
        vn: {
            ...
            'corp_faq_a5': 'Chúng tôi cung cấp bản tóm tắt cốt lõi bằng tiếng mẹ đẻ của người lao động từ bảng kết quả tiếng Hàn vốn có nhiều thuật ngữ chuyên môn. Đây là bản dịch đơn giản nhằm mục đích truyền đạt nội dung, đảm bảo quyền được biết của người lao động, không phải là ý khoa.',
