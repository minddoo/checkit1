document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'why_us_feature2_desc': '전문 교육을 이수한 전담 매니저가 근로자와 1:1로 소통하며, 예약부터 행정 안내까지 모든 과정을 밀착 관리합니다.',
        ...
        en: {
            ...
            'why_us_feature2_desc': 'Professional dedicated managers communicate 1:1 with workers, providing close management for all processes from booking to administrative guidance.',
        ...
        cn: {
            ...
            'why_us_feature2_desc': '经过专业培训的专属经理与员工进行 1:1 沟通，提供从预约到行政指导的全流程贴身管理。',
        ...
        vn: {
            ...
            'why_us_feature2_desc': 'Manager chuyên trách được đào tạo chuyên nghiệp trao đổi 1:1 với lao động, quản lý sát sao toàn bộ quy trình từ đặt lịch đến hướng dẫn hành chính.',
