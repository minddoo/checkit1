document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'corp_sec1_item1_desc': '국내 제조·생산 현장의 외국인 비중은 매년 역대 최고치를 경신하고 있습니다.',
            ...
            'corporate_service2_title': '생산성 및 안전 증대',
            'corporate_service2_desc': '정기적인 검진으로 질병을 조기 발견하여 근로자의 건강을 지키고 산업재해 위험을 낮춥니다.',
            'corporate_service3_title': '높은 참여도와 만족도',
            'corporate_service3_desc': '언어 장벽 없는 편안한 검진은 외국인 근로자의 참여율을 높이고 기업에 대한 긍정적 인식을 만듭니다.',
            'corporate_process_title': '진행 프로세스',
            'corporate_process_step1_title': '도입 상담',
            'corporate_process_step1_desc': '기업의 규모와 요구사항을 분석하여 최적의 검진 플랜을 제안합니다.',
            'corporate_process_step2_title': '맞춤형 설계',
            'corporate_process_step2_desc': '외국인 근로자를 위한 다국어 안내 자료와 효율적인 검진 시스템을 준비합니다.',
            'corporate_process_step3_title': '운영 및 관리',
            'corporate_process_step3_desc': '예약부터 사후 관리까지 CHECKIT이 원스톱으로 지원하여 행정 부담을 없앱니다.',
            ...
            'refund_policy_title': '환불 정책',
            'non_refundable_title': '환불 불가 상황',
            'non_refundable_desc': '아래 범주에 해당하는 경우 환불이 불가능합니다. 이러한 경우는 저희의 통제 범위를 벗어나며, 병원 자체의 행정 또는 의료 절차 내에서 발생합니다.',
            'non_refundable_item1': '병원 측 문제 (지연, 시스템 오류, 의사 일정 변경, 추가 검사 필요)',
            'non_refundable_item2': '고객의 준비 부족',
            'non_refundable_item3': '고객이 제공된 안내를 따르지 않은 경우',
            'non_refundable_item4': '부정확하거나 불완전한 설문지',
            'non_refundable_item5': '금식 실패 또는 제한된 음식 섭취',
            'non_refundable_item6': '고객의 일정 실수',
            'non_refundable_item7': '병원으로 인한 결과 지연',
            'non_refundable_item8': '고객의 필요 정보 제출 지연',
            'non_refundable_item9': '의료 시스템 내에서 자연적으로 발생 가능한 이벤트 (예상치 못한 업무 흐름 지연, 내부 처리 시간, 병원 프로토콜)',
            'full_refund_title': '전액 환불 상황',
            'full_refund_desc': '실수가 명백히 저희 측에 있는 경우에만 전액 환불이 가능합니다.',
            'full_refund_item1': '저희가 잘못된 정보(잘못된 날짜, 잘못된 안내, 잘못된 양식)를 제공한 경우',
            'full_refund_item2': '필수 공지 또는 준비 안내를 보내지 않은 경우',
            'full_refund_item3': '플랜에 포함된 서류 요청을 누락한 경우',
            'full_refund_item4': '저희의 오류로 인해 결과가 지연된 경우',
        ...
        en: {
            ...
            'corporate_solutions_title': 'The Optimal Partner for Enterprises',
            'corporate_service1_title': 'Health Manager Workload Reduction',
            'corporate_service1_desc': 'CHECKIT handles complex administrative tasks such as group reservations, scheduling, and results management, improving health manager efficiency.',
            'corporate_service2_title': 'Increased Productivity and Safety',
            'corporate_service2_desc': 'Regular check-ups help detect diseases early, protecting employees\' health and lowering industrial accident risks.',
            'corporate_service3_title': 'High Participation and Satisfaction',
            'corporate_service3_desc': 'Comfortable check-ups without language barriers increase participation rates among foreign workers and build a positive image of the company.',
            'corporate_process_title': 'Process',
            'corporate_process_step1_title': 'Consultation',
            'corporate_process_step1_desc': 'We analyze company size and requirements to propose the optimal screening plan.',
            'corporate_process_step2_title': 'Customized Design',
            'corporate_process_step2_desc': 'We prepare multilingual guides and efficient screening systems for foreign employees.',
            'corporate_process_step3_title': 'Operation & Management',
            'corporate_process_step3_desc': 'CHECKIT provides one-stop support from reservation to post-management, eliminating administrative burdens.',
            ...
            'non_refundable_title': 'Non-Refundable Situations',
            'non_refundable_desc': 'Refunds are not possible for cases that fall under the categories below. These cases are beyond our control and occur within the hospital’s own administrative or medical procedures.',
            'non_refundable_item1': 'Hospital-side issues (delays, system errors, doctor schedule changes, need for additional tests)',
            'non_refundable_item2': 'Lack of preparation by the client',
            'non_refundable_item3': 'Client not following the provided instructions',
            'non_refundable_item4': 'Inaccurate or incomplete questionnaire',
            'non_refundable_item5': 'Failure to fast or consumption of restricted foods',
            'non_refundable_item6': 'Client’s scheduling mistake',
            'non_refundable_item7': 'Result delays due to the hospital',
            'non_refundable_item8': 'Delayed submission of required information by the client',
            'non_refundable_item9': 'Naturally occurring events within the medical system (unexpected workflow delays, internal processing time, hospital protocols)',
            'full_refund_title': 'Full Refund Situations',
            'full_refund_desc': 'A full refund is only possible if the mistake is clearly on our part.',
            'full_refund_item1': 'We provided incorrect information (wrong date, wrong guide, wrong form)',
            'full_refund_item2': 'We failed to send essential notices or preparation guides',
            'full_refund_item3': 'We missed a document request that was included in the plan',
            'full_refund_item4': 'Results were delayed due to our error',
        ...
        cn: {
            ...
            'corporate_solutions_title': '企业的最佳合作伙伴',
            'corporate_service1_title': '减轻健康管理员负担',
            'corporate_service1_desc': 'CHECKIT负责处理团体预约、日程安排和结果管理等复杂行政任务，提高健康管理效率。',
            'corporate_service2_title': '提高生产力与安全性',
            'corporate_service2_desc': '通过定期检查早期发现疾病，保护员工健康并降低工业事故风险。',
            'corporate_service3_title': '高参与度与满意度',
            'corporate_service3_desc': '无语言障碍的舒适体检提高了外国员工的参与率，并树立了企业的良好形象。',
            'corporate_process_title': '进行流程',
            'corporate_process_step1_title': '导入咨询',
            'corporate_process_step1_desc': '分析企业规模和需求，提出最佳体检计划。',
            'corporate_process_step2_title': '定制设计',
            'corporate_process_step2_desc': '为外国员工准备多语言导引资料和高效体检系统。',
            'corporate_process_step3_title': '运营与管理',
            'corporate_process_step3_desc': 'CHECKIT提供从预约到后期管理的一站式支持，消除行政负担。',
            ...
            'non_refundable_title': '不可退款的情况',
            'non_refundable_desc': '以下情况不予退款。这些情况超出我们的控制范围，属于医院自身的行政或医疗程序。',
            'non_refundable_item1': '医院方面的问题（延迟、系统错误、医生日程变更、需要额外检查）',
            'non_refundable_item2': '客户准备不足',
            'non_refundable_item3': '客户未遵守提供的指示',
            'non_refundable_item4': '问卷不准确或不完整',
            'non_refundable_item5': '禁食失败或食用了限制性食物',
            'non_refundable_item6': '客户的日程安排失误',
            'non_refundable_item7': '因医院原因导致结果延迟',
            'non_refundable_item8': '客户延迟提交所需信息',
            'non_refundable_item9': '医疗系统内可能自然发生的事件（意外的工作流程延迟、内部处理时间、医院协议）',
            'full_refund_title': '全额退款的情况',
            'full_refund_desc': '只有在错误明显在我方时，才可能全额退款。',
            'full_refund_item1': '我们提供了错误的信息（错误的日期、错误的指南、错误的表格）',
            'full_refund_item2': '我们未能发送必要的通知或准备指南',
            'full_refund_item3': '我们遗漏了计划中包含的文件索取请求',
            'full_refund_item4': '由于我们的错误导致结果延迟',
            'chatbot_header': 'Check Bot',
        ...
        vn: {
            ...
            'corporate_solutions_title': 'Đối tác tối ưu cho doanh nghiệp',
            'corporate_service1_title': 'Giảm gánh nặng cho cán bộ quản lý sức khỏe',
            'corporate_service1_desc': 'CHECKIT xử lý các nhiệm vụ hành chính phức tạp như đặt chỗ nhóm, lập lịch trình và quản lý kết quả, nâng cao hiệu quả cho quản lý y tế.',
            'corporate_service2_title': 'Nâng cao năng suất và an toàn',
            'corporate_service2_desc': 'Khám sức khỏe định kỳ giúp phát hiện sớm bệnh tật, bảo vệ sức khỏe người lao động và giảm thiểu rủi ro tai nạn lao động.',
            'corporate_service3_title': 'Sự tham gia và hài lòng cao',
            'corporate_service3_desc': 'Khám sức khỏe thoải mái không có rào cản ngôn ngữ làm tăng tỷ lệ tham gia của người lao động nước ngoài và tạo hình ảnh tích cực cho công ty.',
            'corporate_process_title': 'Quy trình thực hiện',
            'corporate_process_step1_title': 'Tư vấn thực hiện',
            'corporate_process_step1_desc': 'Chúng tôi phân tích quy mô và yêu cầu của công ty để đề xuất kế hoạch sàng lọc tối ưu.',
            'corporate_process_step2_title': 'Thiết kế theo yêu cầu',
            'corporate_process_step2_desc': 'Chúng tôi chuẩn bị các hướng dẫn đa ngôn ngữ và hệ thống khám hiệu quả cho nhân viên nước ngoài.',
            'corporate_process_step3_title': 'Vận hành và quản lý',
            'corporate_process_step3_desc': 'CHECKIT cung cấp hỗ trợ một cửa từ đặt chỗ đến quản lý sau khám, loại bỏ gánh nặng hành chính.',
            ...
            'non_refundable_title': 'Các trường hợp không được hoàn tiền',
            'non_refundable_desc': 'Việc hoàn tiền không thể thực hiện đối với các trường hợp thuộc các danh mục dưới đây. Những trường hợp này nằm ngoài tầm kiểm soát của chúng tôi và xảy ra trong các thủ tục hành chính hoặc y tế của riêng bệnh viện.',
            'non_refundable_item1': 'Các vấn đề từ phía bệnh viện (chậm trễ, lỗi hệ thống, thay đổi lịch của bác sĩ, cần xét nghiệm bổ sung)',
            'non_refundable_item2': 'Khách hàng không chuẩn bị đầy đủ',
            'non_refundable_item3': 'Khách hàng không tuân theo hướng dẫn được cung cấp',
            'non_refundable_item4': 'Bảng câu hỏi không chính xác hoặc không đầy đủ',
            'non_refundable_item5': 'Không nhịn ăn hoặc tiêu thụ thực phẩm bị hạn chế',
            'non_refundable_item6': 'Sai sót trong lịch trình của khách hàng',
            'non_refundable_item7': 'Kết quả chậm trễ do bệnh viện',
            'non_refundable_item8': 'Khách hàng chậm trễ nộp thông tin cần thiết',
            'non_refundable_item9': 'Các sự kiện xảy ra tự nhiên trong hệ thống y tế (chậm trễ quy trình làm việc không mong muốn, thời gian xử lý nội bộ, quy trình của bệnh viện)',
            'full_refund_title': 'Các trường hợp được hoàn tiền đầy đủ',
            'full_refund_desc': 'Chỉ có thể hoàn lại toàn bộ tiền nếu sai sót rõ ràng thuộc về phía chúng tôi.',
            'full_refund_item1': 'Chúng tôi đã cung cấp thông tin không chính xác (sai ngày, sai hướng dẫn, sai biểu mẫu)',
            'full_refund_item2': 'Chúng tôi đã không gửi các thông báo cần thiết hoặc hướng dẫn chuẩn bị',
            'full_refund_item3': 'Chúng tôi đã bỏ lỡ một yêu cầu tài liệu đã được bao gồm trong kế hoạch',
            'full_refund_item4': 'Kết quả bị chậm trễ do lỗi của chúng tôi',
            'chatbot_header': 'Check Bot',
