document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'chatbot_a1': '전담 매니저가 희망 일정에 맞춰 병원 예약부터 전 과정을 도와드립니다.',
            'chatbot_q2': '병원/의료인과 계약 구조인가요?',
            'chatbot_a2': '특정 병원과 계약 없이 고객님께 가장 적합한 병원을 객관적으로 추천합니다.',
            'chatbot_q3': '의료행위나 진료 알선도 하나요?',
            'chatbot_a3': '의료법을 준수하며 예약, 통역 등 비의료적 행정 지원 서비스만 제공합니다.',
            'chatbot_q4': '검진 당일 어떤 도움을 받을 수 있나요?',
            'chatbot_a4': '전담 매니저가 실시간 동행하여 접수, 문진, 수납 등 모든 소통을 지원합니다.',
        ...
        en: {
            ...
            'chatbot_q1': 'How do I make a reservation?',
            'chatbot_a1': 'A dedicated manager will handle everything from hospital selection to booking.',
            'chatbot_q2': 'Do you have contracts with hospitals/doctors?',
            'chatbot_a2': 'No, we provide objective recommendations without being tied to specific hospitals.',
            'chatbot_q3': 'Do you perform medical acts or referrals?',
            'chatbot_a3': 'No, we strictly provide non-medical administrative supports like booking and translation.',
            'chatbot_q4': 'What help can I get on the day of check-up?',
            'chatbot_a4': 'A manager supports all communication including registration and questionnaires in real-time.',
            'chatbot_q5': 'How are the results delivered?',
        ...
        cn: {
            ...
            'chatbot_q1': '如何预约？',
            'chatbot_a1': '专属经理将根据您的日程，提供从医院选择到预约的全程协助。',
            'chatbot_q2': '你们与医院/医生有合同关系吗？',
            'chatbot_a2': '没有，我们不隶属于特定医院，仅为您提供最中立客观的推荐。',
            'chatbot_q3': '你们也提供医疗行为或医疗中介吗？',
            'chatbot_a3': '遵守医疗法，仅提供预约、翻译等非医疗性的行政支援服务。',
            'chatbot_q4': '检查当天我可以得到什么帮助？',
            'chatbot_a4': '专属经理将实时的协助您完成挂号、问诊、结算等所有沟通环节。',
            'chatbot_q5': '结果报告如何交付？',
        ...
        vn: {
            ...
            'chatbot_q1': 'Làm thế nào để đặt lịch?',
            'chatbot_a1': 'Quản lý chuyên trách sẽ hỗ trợ bạn toàn bộ quy trình từ chọn bệnh viện đến đặt lịch.',
            'chatbot_q2': 'Các bạn có hợp đồng với bệnh viện/bác sĩ không?',
            'chatbot_a2': 'Không, chúng tôi cung cấp đề xuất khách quan mà không phụ thuộc vào bệnh viện nào.',
            'chatbot_q3': 'Các bạn có thực hiện hành vi y tế hay môi giới y tế không?',
            'chatbot_a3': 'Tuân thủ luật y tế, chúng tôi chỉ hỗ trợ hành chính phi y tế như đặt lịch và phiên dịch.',
            'chatbot_q4': 'Tôi sẽ nhận được sự giúp đỡ gì vào ngày khám?',
            'chatbot_a4': 'Quản lý sẽ đồng hành trực tuyến để hỗ trợ đăng ký, khám và thanh toán theo thời gian thực.',
            'chatbot_q5': 'Kết quả khám sẽ được chuyển giao như thế nào?',
