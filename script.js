document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'corp_sec7_step1_1': '기업으로부터 검진 대상자 명단 수령 (예: 서희건설)',
        ...
        en: {
            ...
            'corp_sec7_step1_1': 'Receive candidate list from company (e.g., Seohee Construction)',
        ...
        vn: {
            ...
            'corp_sec7_step1_1': 'Nhận danh sách ứng viên từ công ty (VD: Seohee Construction)',
