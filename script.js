document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'expectation_item_title_3': '#3. 현실',
            'expectation_item_desc_3': '“모든 것을 직접 번역해야 하고, 그 번역이 정확한지 확신할 수 없습니다.”',
        ...
        en: {
            ...
            'expectation_item_title_3': '#3. The Reality',
            'expectation_item_desc_3': '“I have to translate everything myself and I\'m not sure if the translation is correct.”',
        ...
        cn: {
            ...
            'expectation_item_title_3': '#3. 现实',
            'expectation_item_desc_3': '“我必须自己翻译所有东西，而且我不确定翻译是否正确。”',
        ...
        vn: {
            ...
            'expectation_item_title_3': '#3. Thực tế',
            'expectation_item_desc_3': '“Tôi phải tự dịch mọi thứ và tôi không chắc bản dịch có đúng không.”',
