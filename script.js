document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'why_us_feature1_desc': '엑셀 명단 업로드 한 번으로 수백 명의 근로자 검진 현황을<br>실시간 파워 대시보드에서 즉각 확인할 수 있습니다.',
            'why_us_feature2_title': '1:1 모국어 전담 매니저 매칭',
            'why_us_feature2_desc': '전담 매니저가 근로자와 1:1로 소통하며,<br>예약부터 행정 안내까지 모든 과정을 밀착 관리합니다.',
            'why_us_feature3_title': '모국어 결과지 번역 및 데이터화',
            'why_us_feature3_desc': '한국어 결과지를 모국어로 단순 번역하여 근로자의 알 권리를 보장하고,<br>기업에는 표준화된 건강 지표를 보고합니다.',
            'why_us_feature4_title': '법적 리스크 및 OHS 완벽 대응',
            'why_us_feature4_desc': '산업안전보건법 및 의료법을 엄격히 준수하며,<br>검진 누락 방지와 사후 관리를 통해 기업의 법적 책임을 빈틈없이 지원합니다.',
