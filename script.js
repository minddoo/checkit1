document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        en: {
            ...
            'corp_sec5_item1_desc': 'Managed directly by multilingual managers who perfectly understand the Korean medical system, not just simple translators.',
        ...
        cn: {
            ...
            'process_step3_desc_new': '我们将您提供的结果报告进行简单的翻译 and 摘要,然后通过电子邮件或即时通讯工具以文件形式交付。',
            ...
            'individual_page_subtitle': 'CHECKIT 帮助所有居住或访问韩国的外国个人无语言障碍地获得最佳的健康体检服务处理。',
            ...
            'corp_sec2_item2_desc': '当健康的员工稳定工作时，企业的生产效率才能得到最大发挥。',
            'corp_sec2_item3_title': 'ESG经营的实践',
            'corp_sec2_item3_desc': '证明您作为尊重多样性和保护人权的领先企业的价值。',
            'corp_sec3_title': '然而，在现场面临的现实却大不相同',
            'corp_sec3_subtitle': '比起预约和体检的“当天”，更困难的是前后的“管理真空”。',
            'corp_sec3_item1_title': '体检前：茫然与恐惧',
            'corp_sec3_item1_p1': '韩语填写的问卷和注意事项，即使使用翻译机也有局限。',
            'corp_sec3_item1_p2': '误解禁食说明导致检查取消或发生事故。',
            ...
            'corp_sec5_item3_desc': '不隶属于特定医院，仅为员工的便利和企业的效率提供最佳选择。',
            'corp_sec6_title': '无需改变现有流程',
            'corp_sec6_subtitle': '完美遵守医疗法，仅最大化企业的运营效率。',
            'corp_sec6_item1_title': '无违反医疗法行为',
            'corp_sec6_item1_desc': '不从事诱导或介绍患者的行为；仅代理非医疗沟通，完全没有法律风险。',
        ...
        vn: {
            ...
            'corp_sec5_item1_desc': 'Được quản lý trực tiếp bởi các quản lý đa ngôn ngữ hiểu rõ hệ thống y tế Hàn Quốc, không chỉ là người dịch đơn thuần.',
