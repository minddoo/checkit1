document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'contact_form_email_label': '이메일 주소', 'contact_form_email_placeholder': '예: example@checkit.com', 'contact_form_phone_label': '연락처', 'contact_form_phone_optional': '(선택사항)', 'contact_form_phone_placeholder': '예: 010-1234-5678', 'contact_form_message_label': '문의 내용', 'contact_form_message_placeholder': '궁금한 점을 자세히 적어주세요.', 'contact_form_submit_button': '문의하기',
        ...
        cn: {
            ...
            'contact_form_email_label': '电子邮件地址', 'contact_form_email_placeholder': '例如：example@checkit.com', 'contact_form_phone_label': '联系电话', 'contact_form_phone_optional': '(可选)', 'contact_form_phone_placeholder': '例如：010-1234-5678', 'contact_form_message_label': '咨询内容', 'contact_form_message_placeholder': '请详细填写您的问题。', 'contact_form_submit_button': '提交咨询',
        ...
        vn: {
            ...
            'contact_form_email_label': 'Địa chỉ email', 'contact_form_email_placeholder': 'ví dụ: example@checkit.com', 'contact_form_phone_label': 'Số điện thoại', 'contact_form_phone_optional': '(Tùy chọn)', 'contact_form_phone_placeholder': 'ví dụ: 010-1234-5678', 'contact_form_message_label': 'Nội dung yêu cầu', 'contact_form_message_placeholder': 'Vui lòng viết chi tiết yêu cầu của bạn.', 'contact_form_submit_button': 'Gửi yêu cầu',
