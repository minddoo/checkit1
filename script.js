document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'why_us_feature1_desc': '실시간 보건관리 모니터링<br>단 한 번의 엑셀 명단 업로드로<br>수백 명 근로자의 검진 현황을 즉시 파악합니다.',
            'why_us_feature2_title': '모국어 전담 매니저',
            'why_us_feature2_desc': '1:1 모국어 전담 매니저 매칭<br>전담 매니저가 근로자와 1:1로 직접 소통하며<br>예약부터 행정까지 전 과정을 밀착 관리합니다.',
            'why_us_feature3_title': '결과지 번역 및 데이터화',
            'why_us_feature3_desc': '모국어 결과지 번역 및 데이터화<br>한국어 결과지를 이해하기 쉽게 번역해<br>근로자의 알 권리를 충실히 보장합니다.',
            'why_us_feature4_title': '법적 리스크 완벽 대응',
            'why_us_feature4_desc': '법적 리스크 및 OHS 완벽 대응<br>산업안전보건법을 엄격하게 준수하며<br>검진 누락 방지와 철저한 사후 관리를 지원합니다.',
