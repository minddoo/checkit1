document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'expectation_title': '당신이 한국의 의료 서비스에 기대하는 것',
            'expectation_subtitle': '한국은 세계 최고 수준의 의료 장비와 의료진을 보유하고 있습니다.',
            'expectation_item_title_1': '합리적인 비용',
            'expectation_item_desc_1': '품질 대비 매우 합리적이고 투명한 검진 비용을 기대합니다.',
            'expectation_item_title_2': '편리한 시스템',
            'expectation_item_desc_2': '최첨단 장비와 효율적인 검사 시스템을 통한 쾌적한 환경을 기대합니다.',
            'expectation_item_title_3': '높은 전문성',
            'expectation_item_desc_3': '풍부한 임상 경험을 가진 전문의의 정밀한 진단과 분석을 기대합니다.',
            'expectation_item_title_4': '빠른 결과 확인',
            'expectation_item_desc_4': '대기 시간의 최소화와 신속한 결과 통보 시스템을 기대합니다.',
            'reality_title': '하지만, 외국인으로서 마주하는 \'비의료적 과정\'의 장벽',
            'reality_item_title_1': '예약의 어려움',
            'reality_item_1_point_1': '복잡한 한국어 웹사이트와 앱',
            'reality_item_1_point_2': '전화 상담 시 소통의 한계',
            'reality_item_1_point_3': '나에게 맞는 검진 항목 선택의 막막함',
            'reality_item_1_point_4': '병원의 위치와 찾아가는 법 안내 부족',
            'reality_item_title_2': '검진 당일의 혼란',
            'reality_item_2_point_1': '한국어로만 된 수많은 문진표 작성',
            'reality_item_2_point_2': '검진 센터 내 복잡한 이동 동선',
            'reality_item_2_point_3': '검사 도중 실시간 지시사항 이해 불가',
            'reality_item_2_point_4': '낯선 환경에서 오는 심리적 불안감',
            'reality_item_title_3': '결과 확인의 장벽',
            'reality_item_3_point_1': '전문 용어로 가득한 한국어 결과지',
            'reality_item_3_point_2': '번역기만으로는 이해하기 힘든 결과 내용',
            'reality_item_3_point_3': '추가 정밀 검사가 필요한지 판단의 어려움',
            'reality_item_3_point_4': '결과에 대한 궁금증을 물어볼 곳의 부재',
            'reality_item_title_4': '사후 관리의 부재',
            'reality_item_4_point_1': '검사 결과 이후의 건강 가이드 부족',
            'reality_item_4_point_2': '다음 검진 주기 알림 서비스 없음',
            'reality_item_4_point_3': '이상이 발견되었을 때의 진료 연계 막막함',
            'reality_item_4_point_4': '지속적인 건강 데이터 관리의 어려움',
            'reality_overtime_title': '관리되지 않는 시간들이 당신의 건강을 위협합니다',
            'reality_overtime_p1': '일정 누락',
            'reality_overtime_p2': '잘못된 금식',
            'reality_overtime_p3': '검사 취소',
            'reality_overtime_p4': '소통 오류',
            'reality_overtime_p5': '검사 사고',
            'reality_overtime_p6': '이해도 0%',
            'reality_overtime_p7': '결과 방치',
            'reality_overtime_p8': '재검사 놓침',
            'reality_overtime_p9': '질병 악화',
            'reality_overtime_p10': '의료 소외',
            'reality_overtime_p11': '공백 발생',
            'solution_title': 'CHECKIT이 제안하는 솔루션',
            'solution_subtitle': '우리는 의료 행위를 제외한 모든 과정에서 당신의 가장 든든한 파트너가 됩니다.',
            'individual_service1_title': '1:1 전담 매니저 매칭',
            'individual_service1_desc': '당신의 언어를 사용하는 전문 매니저가 병원 선택부터 예약까지 전 과정을 직접 관리합니다.',
            'individual_service2_title_new': '실시간 텍스트 소통 지원',
            'individual_service2_desc_new': '검진 당일, 병원 내에서 발생하는 모든 소통을 실시간 텍스트로 도와드려 혼란을 없앱니다.',
            'individual_service3_title_new': '모국어 결과지 요약 제공',
            'individual_service3_desc_new': '어려운 한국어 결과지를 당신의 언어로 핵심만 요약하여 파일로 전달해 드립니다.',
            'packages_title': '서비스 패키지',
            'packages_subtitle': '당신에게 꼭 필요한 도움의 수준을 선택하세요.',
            'package1_title': '혼란 방지 플랜',
            'package1_price': '₩138,000',
            'package_includes': '포함 사항:',
            'package1_feature1': '상담 및 병원 선택 지원',
            'package1_feature2': '최종 예약 대행',
            'package1_feature3': '검진 전 주의사항 번역 제공',
            'package1_feature4': '문진표 사전 작성 가이드',
            'package1_feature5': '병원 위치 및 주차 안내',
            'package1_feature6': '-',
            'package1_feature7': '-',
            'package1_feature8': '-',
            'package1_feature9': '-',
            'package_recommend_title': '추천 대상:',
            'package1_recommend_desc': '예약 과정의 번거로움만 해결하고 싶으신 분',
            'package2_title': '실수 제로 플랜',
            'package2_price': '₩276,000',
            'package2_includes': '포함 사항:',
            'package2_feature1': '상담 및 병원 선택 지원',
            'package2_feature2': '최종 예약 대행',
            'package2_feature3': '검진 전 주의사항 번역 제공',
            'package2_feature4': '문진표 사전 작성 가이드',
            'package2_feature5': '병원 위치 및 주차 안내',
            'package2_feature6': '검진 당일 실시간 텍스트 지원',
            'package2_feature7': '결과지 수령 방법 안내',
            'package2_feature8': '-',
            'package2_feature9': '-',
            'package2_recommend_desc': '검진 당일 병원 내 소통이 걱정되시는 분',
            'package3_title': '토탈 안심 플랜',
            'package3_price': '₩414,000',
            'package3_includes': '포함 사항:',
            'package3_feature1': '상담 및 병원 선택 지원',
            'package3_feature2': '최종 예약 대행',
            'package3_feature3': '검진 전 주의사항 번역 제공',
            'package3_feature4': '문진표 사전 작성 가이드',
            'package3_feature5': '병원 위치 및 주차 안내',
            'package3_feature6': '검진 당일 실시간 텍스트 지원',
            'package3_feature7': '결과지 수령 방법 안내',
            'package3_feature8': '결과지 모국어 단순 번역',
            'package3_feature9': '결과 핵심 내용 요약 리포트',
            'package3_feature10': '재검사 필요 유무 확인',
            'package3_feature11': '병원 서류 발급 요청 지원',
            'package3_feature12': '다음 검진 주기 알림',
            'package3_feature13': '1:1 건강 상담 Q&A (비의료적)',
            'package3_recommend_desc': '결과 확인과 사후 관리까지 완벽하게 지원받고 싶으신 분',
            ...
            'notice_title': '꼭 확인해주세요',
            'notice_subtitle': 'CHECKIT은 의료법을 준수합니다.',
            'notice_quote': '“CHECKIT은 의료 기관이 아니며, 의료 행위(진단, 치료, 처방) 및 환자 유인·알선을 일절 하지 않습니다.”',
            'notice_answer_title': 'CHECKIT은 무엇을 하나요?',
            'notice_answer_p1': '우리는 병원 예약 대행, 통역, 결과지 단순 번역과 같은 \'비의료적 행정 지원\' 서비스만을 제공합니다.',
            'notice_answer_p2': '우리는 고객님의 입장에서 정보를 수집하고 전달하는 \'소통의 대행자\' 역할을 수행합니다.',
            'notice_reality_title': '의료적 판단은 의사에게',
            'notice_reality_p1': '검사 결과에 대한 의학적 해석이나 치료 방향 설정은 반드시 해당 의료기관의 전문의와 상의하셔야 합니다. CHECKIT은 결과지의 텍스트를 단순 번역하여 요약해 드릴 뿐입니다.',
            'notice_situation_title': '독립적인 서비스 운영',
            'notice_situation_p1': 'CHECKIT은 특정 병원과 제휴하여 수수료를 받는 구조가 아닙니다. 오직 고객님의 편의를 위해 독립적으로 운영되는 유료 서비스입니다.',
        ...
        en: {
            ...
            'expectation_title': 'What You Expect from Korean Medical Services',
            'expectation_subtitle': 'Korea has world-class medical equipment and medical staff.',
            'expectation_item_title_1': 'Reasonable Costs',
            'expectation_item_desc_1': 'Expected very reasonable and transparent check-up costs compared to quality.',
            'expectation_item_title_2': 'Convenient Systems',
            'expectation_item_desc_2': 'Expected a pleasant environment through state-of-the-art equipment and efficient inspection systems.',
            'expectation_item_title_3': 'High Expertise',
            'expectation_item_desc_3': 'Expected precise diagnosis and analysis by specialists with abundant clinical experience.',
            'expectation_item_title_4': 'Fast Result Checking',
            'expectation_item_desc_4': 'Expected minimized waiting time and rapid result notification systems.',
            'reality_title': 'However, the Barrier of \'Non-medical Processes\' as a Foreigner',
            'reality_item_title_1': 'Difficulty in Booking',
            'reality_item_1_point_1': 'Complex Korean websites and apps',
            'reality_item_1_point_2': 'Communication limits during phone consultations',
            'reality_item_1_point_3': 'Confusion in choosing check-up items that fit me',
            'reality_item_1_point_4': 'Lack of guidance on hospital location and directions',
            'reality_item_title_2': 'Confusion on the Day of Check-up',
            'reality_item_2_point_1': 'Filling out numerous questionnaires in Korean only',
            'reality_item_2_point_2': 'Complex movement paths within the check-up center',
            'reality_item_2_point_3': 'Inability to understand real-time instructions during tests',
            'reality_item_2_point_4': 'Psychological anxiety from an unfamiliar environment',
            'reality_item_title_3': 'Barrier to Checking Results',
            'reality_item_3_point_1': 'Korean result sheets full of technical terms',
            'reality_item_3_point_2': 'Difficult result contents to understand with only translators',
            'reality_item_3_point_3': 'Difficulty in judging whether additional precise tests are needed',
            'reality_item_3_point_4': 'Absence of a place to ask questions about results',
            'reality_item_title_4': 'Absence of Follow-up Care',
            'reality_item_4_point_1': 'Lack of health guides after test results',
            'reality_item_4_point_2': 'No notification service for the next check-up cycle',
            'reality_item_4_point_3': 'Confusion in medical linkage when abnormalities are found',
            'reality_item_4_point_4': 'Difficulty in continuous health data management',
            'reality_overtime_title': 'Unmanaged time threatens your health',
            'reality_overtime_p1': 'Missed schedule',
            'reality_overtime_p2': 'Wrong fasting',
            'reality_overtime_p3': 'Cancelled test',
            'reality_overtime_p4': 'Comm. error',
            'reality_overtime_p5': 'Test accident',
            'reality_overtime_p6': '0% Understanding',
            'reality_overtime_p7': 'Neglected results',
            'reality_overtime_p8': 'Missed re-exam',
            'reality_overtime_p9': 'Disease worsens',
            'reality_overtime_p10': 'Medical alienation',
            'reality_overtime_p11': 'Gap occurs',
            'solution_title': 'Solutions Suggested by CHECKIT',
            'solution_subtitle': 'We become your most reliable partner in all processes except medical acts.',
            'individual_service1_title': '1:1 Dedicated Manager Matching',
            'individual_service1_desc': 'A professional manager who speaks your language directly manages the entire process from hospital selection to booking.',
            'individual_service2_title_new': 'Real-time Text Communication Support',
            'individual_service2_desc_new': 'On the day of the check-up, we help with all communication within the hospital via real-time text to eliminate confusion.',
            'individual_service3_title_new': 'Native Language Result Summary',
            'individual_service3_desc_new': 'We summarize only the key points of the difficult Korean result sheet in your language and deliver it as a file.',
            'packages_title': 'Service Packages',
            'packages_subtitle': 'Choose the level of help you definitely need.',
            'package1_title': 'No-Confusion Plan',
            'package1_price': '₩138,000',
            'package_includes': 'Includes:',
            'package1_feature1': 'Consultation & Hospital Selection Support',
            'package1_feature2': 'Final Reservation Proxy',
            'package1_feature3': 'Pre-check-up Precautions Translation',
            'package1_feature4': 'Questionnaire Pre-filling Guide',
            'package1_feature5': 'Hospital Location & Parking Guide',
            'package1_feature6': '-',
            'package1_feature7': '-',
            'package1_feature8': '-',
            'package1_feature9': '-',
            'package_recommend_title': 'Recommended for:',
            'package1_recommend_desc': 'Those who only want to solve the hassle of the booking process',
            'package2_title': 'Zero-Mistake Plan',
            'package2_price': '₩276,000',
            'package2_includes': 'Includes:',
            'package2_feature1': 'Consultation & Hospital Selection Support',
            'package2_feature2': 'Final Reservation Proxy',
            'package2_feature3': 'Pre-check-up Precautions Translation',
            'package2_feature4': 'Questionnaire Pre-filling Guide',
            'package2_feature5': 'Hospital Location & Parking Guide',
            'package2_feature6': 'Real-time Text Support on Check-up Day',
            'package2_feature7': 'Guide on How to Receive Result Sheets',
            'package2_feature8': '-',
            'package2_feature9': '-',
            'package2_recommend_desc': 'Those worried about communication within the hospital on the check-up day',
            'package3_title': 'Total-Safe Plan',
            'package3_price': '₩414,000',
            'package3_includes': 'Includes:',
            'package3_feature1': 'Consultation & Hospital Selection Support',
            'package3_feature2': 'Final Reservation Proxy',
            'package3_feature3': 'Pre-check-up Precautions Translation',
            'package3_feature4': 'Questionnaire Pre-filling Guide',
            'package3_feature5': 'Hospital Location & Parking Guide',
            'package3_feature6': 'Real-time Text Support on Check-up Day',
            'package3_feature7': 'Guide on How to Receive Result Sheets',
            'package3_feature8': 'Native Language Simple Translation of Results',
            'package3_feature9': 'Key Content Summary Report of Results',
            'package3_feature10': 'Checking Need for Re-examination',
            'package3_feature11': 'Hospital Document Issuance Request Support',
            'package3_feature12': 'Next Check-up Cycle Notification',
            'package3_feature13': '1:1 Health Consultation Q&A (Non-medical)',
            'package3_recommend_desc': 'Those who want perfect support up to result checking and follow-up care',
            'options_title_new': 'Optional Services',
            'option_card_title_1': 'Non-medical Guide',
            'option_card_price_1': '₩82,800',
            'option_card_desc_1': 'Non-medical guide on test items, result structure, and post-test management.',
            'option_card_title_2': 'Hospital Path Guidance',
            'option_card_price_2': '₩27,600',
            'option_card_desc_2': 'Shows exact paths and movement flows within the hospital. Useful for first-time visitors.',
            'option_card_title_3': 'Booking Change Option',
            'option_card_desc_3': 'Option for clients who need to change their reservation after booking.',
            ...
            'option_card_price_4': '₩27,600',
            'option_card_desc_4': 'Requests an English receipt suitable for insurance purposes on your behalf.',
            'option_card_title_5': 'CD Result Request',
            'option_card_price_5': '₩27,600',
            'option_card_desc_5': 'Requests a test CD or additional imaging files on your behalf.',
            'option_card_title_6': 'Emergency Result Follow-up',
            'option_card_price_6': '₩27,600',
            'option_card_desc_6': 'Sends an emergency follow-up message to the hospital once.',
            'notice_title': 'Please Check',
            'notice_subtitle': 'CHECKIT complies with medical laws.',
            'notice_quote': '“CHECKIT is not a medical institution and does not engage in medical acts (diagnosis, treatment, prescription) or patient solicitation/referral.”',
            'notice_answer_title': 'What does CHECKIT do?',
            'notice_answer_p1': 'We only provide \'non-medical administrative support\' services such as hospital booking proxy, interpretation, and simple translation of result sheets.',
            'notice_answer_p2': 'We perform the role of a \'communication proxy\' that collects and delivers information from your perspective.',
            'notice_reality_title': 'Medical judgment is for doctors',
            'notice_reality_p1': 'Medical interpretation of test results or setting treatment directions must be consulted with a specialist at the relevant medical institution. CHECKIT only provides a simple translation and summary of the text on the result sheet.',
            'notice_situation_title': 'Independent Service Operation',
            'notice_situation_p1': 'CHECKIT is not structured to receive fees through partnerships with specific hospitals. It is a paid service operated independently solely for your convenience.',
        ...
        cn: {
            ...
            'expectation_title': '您对韩国医疗服务的期待',
            'expectation_subtitle': '韩国拥有世界一流的医疗设备和医护人员.',
            'expectation_item_title_1': '合理的费用',
            'expectation_item_desc_1': '期待与质量相比非常合理且透明的体检费用.',
            'expectation_item_title_2': '便捷的系统',
            'expectation_item_desc_2': '期待通过最先进的设备和高效的检查系统提供舒适的环境.',
            'expectation_item_title_3': '高专业性',
            'expectation_item_desc_3': '期待拥有丰富临床经验的专科医生进行精准的诊断和分析.',
            'expectation_item_title_4': '快速确认结果',
            'expectation_item_desc_4': '期待最小化等待时间和快速的结果通知系统.',
            'reality_title': '然而，作为外国人面临的“非医疗过程”障碍',
            'reality_item_title_1': '预约困难',
            'reality_item_1_point_1': '复杂的韩语网站和应用程序',
            'reality_item_1_point_2': '电话咨询时的沟通限制',
            'reality_item_1_point_3': '对选择适合自己的体检项目感到茫然',
            'reality_item_1_point_4': '缺乏关于医院位置和路线的指引',
            'reality_item_title_2': '体检当天的混乱',
            'reality_item_2_point_1': '填写大量仅有韩语的问卷',
            'reality_item_2_point_2': '体检中心内复杂的移动路线',
            'reality_item_2_point_3': '无法理解检查过程中的实时指令',
            'reality_item_2_point_4': '陌生环境带来的心理不安',
            'reality_item_title_3': '确认结果的障碍',
            'reality_item_3_point_1': '布满专业术语的韩语结果单',
            'reality_item_3_point_2': '仅靠翻译机难以理解的结果内容',
            'reality_item_3_point_3': '难以判断是否需要进一步精密检查',
            'reality_item_3_point_4': '没有可以询问结果疑问的地方',
            'reality_item_title_4': '缺乏后续管理',
            'reality_item_4_point_1': '体检结果后的健康指引不足',
            'reality_item_4_point_2': '没有下一次体检周期的通知服务',
            'reality_item_4_point_3': '发现异常时对就医衔接感到茫然',
            'reality_item_4_point_4': '持续进行健康数据管理的困难',
            'reality_overtime_title': '未被管理的时间正威胁着您的健康',
            'reality_overtime_p1': '日程遗漏',
            'reality_overtime_p2': '错误空腹',
            'reality_overtime_p3': '检查取消',
            'reality_overtime_p4': '沟通错误',
            'reality_overtime_p5': '检查事故',
            'reality_overtime_p6': '理解度 0%',
            'reality_overtime_p7': '结果放置',
            'reality_overtime_p8': '错过复检',
            'reality_overtime_p9': '病情恶化',
            'reality_overtime_p10': '医疗疏远',
            'reality_overtime_p11': '出现空隙',
            'solution_title': 'CHECKIT 提议的解决方案',
            'solution_subtitle': '在除医疗行为外的所有过程中，我们成为您最可靠的合作伙伴.',
            'individual_service1_title': '1:1 专属经理匹配',
            'individual_service1_desc': '使用您的语言的专业经理直接管理从选择医院到预约的整个过程.',
            'individual_service2_title_new': '实时文字沟通支持',
            'individual_service2_desc_new': '在体检当天，我们通过实时文字协助医院内的所有沟通，消除混乱.',
            'individual_service3_title_new': '提供母语结果摘要',
            'individual_service3_desc_new': '我们将复杂的韩语结果单核心内容摘要成您的语言并以文件形式交付.',
            'packages_title': '服务方案',
            'packages_subtitle': '请选择您最需要的帮助级别.',
            'package1_title': '防混乱方案',
            'package1_price': '₩138,000',
            'package_includes': '包含项目：',
            'package1_feature1': '咨询与医院选择支持',
            'package1_feature2': '最终代办预约',
            'package1_feature3': '提供体检前注意事项翻译',
            'package1_feature4': '问卷预填写指南',
            'package1_feature5': '医院位置及停车指引',
            'package1_feature6': '-',
            'package1_feature7': '-',
            'package1_feature8': '-',
            'package1_feature9': '-',
            'package_recommend_title': '推荐对象：',
            'package1_recommend_desc': '只想解决预约过程中的繁琐问题的客户',
            'package2_title': '零失误方案',
            'package2_price': '₩276,000',
            'package2_includes': '包含项目：',
            'package2_feature1': '咨询与医院选择支持',
            'package2_feature2': '最终代办预约',
            'package2_feature3': '提供体检前注意事项翻译',
            'package2_feature4': '问卷预填写指南',
            'package2_feature5': '医院位置及停车指引',
            'package2_feature6': '体检当天实时文字支持',
            'package2_feature7': '结果单领取方式指引',
            'package2_feature8': '-',
            'package2_feature9': '-',
            'package2_recommend_desc': '担心体检当天医院内沟通问题的客户',
            'package3_title': '全面安心方案',
            'package3_price': '₩414,000',
            'package3_includes': '包含项目：',
            'package3_feature1': '咨询与医院选择支持',
            'package3_feature2': '最终代办预约',
            'package3_feature3': '提供体检前注意事项翻译',
            'package3_feature4': '问卷预填写指南',
            'package3_feature5': '医院位置及停车指引',
            'package3_feature6': '体检当天实时文字支持',
            'package3_feature7': '结果单领取方式指引',
            'package3_feature8': '结果单母语简单翻译',
            'package3_feature9': '结果核心内容摘要报告',
            'package3_feature10': '确认是否需要复检',
            'package3_feature11': '支持申请开具医院文件',
            'package3_feature12': '下一次体检周期提醒',
            'package3_feature13': '1:1 健康咨询 Q&A (非医疗性)',
            'package3_recommend_desc': '希望获得从确认结果到后续管理完美支持的客户',
            'options_title_new': '增值服务',
            'option_card_title_1': '非医疗指引',
            'option_card_price_1': '₩82,800',
            'option_card_desc_1': '关于检查项目、结果结构及检查后管理的非医疗性指引.',
            'option_card_title_2': '医院动线导引',
            'option_card_price_2': '₩27,600',
            'option_card_desc_2': '展示医院内精准的动线和移动流程. 对首次访问者很有帮助.',
            'option_card_title_3': '预约变更选项',
            'option_card_desc_3': '为预约后需要变更日程的客户提供的选项.',
            'option_card_3_item_1': '变更 1 次：',
            'option_card_3_item_2': '2 次套餐：',
            'option_card_3_item_3': '无限次变更：',
            'option_card_title_4': '申请英文收据',
            'option_card_price_4': '₩27,600',
            'option_card_desc_4': '代为申请适用于保险目的的英文收据.',
            'option_card_title_5': '申请 CD 结果',
            'option_card_price_5': '₩27,600',
            'option_card_desc_5': '代为申请检查 CD 或额外的影像文件.',
            'option_card_title_6': '紧急结果后续跟进',
            'option_card_price_6': '₩27,600',
            'option_card_desc_6': '向医院发送一次紧急后续跟进信息.',
            'notice_title': '请务必确认',
            'notice_subtitle': 'CHECKIT 遵守医疗法.',
            'notice_quote': '“CHECKIT 不是医疗机构，绝不从事医疗行为（诊断、治疗、处方）以及诱导或介绍患者.”',
            'notice_answer_title': 'CHECKIT 做什么？',
            'notice_answer_p1': '我们仅提供“非医疗性行政支持”服务，如代办医院预约、口译、结果单简单翻译等.',
            'notice_answer_p2': '我们扮演“沟通代理人”的角色，站在客户的角度收集并传递信息.',
            'notice_reality_title': '医疗判断请咨询医生',
            'notice_reality_p1': '对检查结果的医学解释或治疗方向的设定，必须咨询相关医疗机构的专科医生. CHECKIT 仅对结果单的文字进行简单翻译和摘要.',
            'notice_situation_title': '独立服务运营',
            'notice_situation_p1': 'CHECKIT 不采取与特定医院合作并收取佣金的模式. 它是为了客户的便利而独立运营的付费服务.',
        ...
        vn: {
            ...
            'expectation_title': 'Những gì bạn mong đợi từ các dịch vụ y tế của Hàn Quốc',
            'expectation_subtitle': 'Hàn Quốc có trang thiết bị y tế và đội ngũ nhân viên y tế đẳng cấp thế giới.',
            'expectation_item_title_1': 'Chi phí hợp lý',
            'expectation_item_desc_1': 'Chi phí khám sức khỏe rất hợp lý và minh bạch so với chất lượng.',
            'expectation_item_title_2': 'Hệ thống tiện lợi',
            'expectation_item_desc_2': 'Môi trường dễ chịu thông qua các thiết bị tiên tiến và hệ thống kiểm tra hiệu quả.',
            'expectation_item_title_3': 'Chuyên môn cao',
            'expectation_item_desc_3': 'Chẩn đoán và phân tích chính xác bởi các chuyên gia có kinh nghiệm lâm sàng phong phú.',
            'expectation_item_title_4': 'Kiểm tra kết quả nhanh chóng',
            'expectation_item_desc_4': 'Thời gian chờ đợi được giảm thiểu và hệ thống thông báo kết quả nhanh chóng.',
            'reality_title': 'Tuy nhiên, rào cản của các \'quy trình phi y tế\' khi là người nước ngoài',
            'reality_item_title_1': 'Khó khăn khi đặt hẹn',
            'reality_item_1_point_1': 'Các trang web và ứng dụng tiếng Hàn phức tạp',
            'reality_item_1_point_2': 'Hạn chế giao tiếp khi tư vấn qua điện thoại',
            'reality_item_1_point_3': 'Hoang mang khi chọn các hạng mục khám phù hợp',
            'reality_item_1_point_4': 'Thiếu hướng dẫn về vị trí bệnh viện và cách đi lại',
            'reality_item_title_2': 'Sự hỗn loạn trong ngày khám',
            'reality_item_2_point_1': 'Điền vô số bảng câu hỏi chỉ bằng tiếng Hàn',
            'reality_item_2_point_2': 'Lối đi di chuyển phức tạp trong trung tâm khám',
            'reality_item_2_point_3': 'Không thể hiểu các chỉ dẫn thời gian thực trong khi khám',
            'reality_item_2_point_4': 'Lo lắng tâm lý từ một môi trường xa lạ',
            'reality_item_title_3': 'Rào cản khi kiểm tra kết quả',
            'reality_item_3_point_1': 'Phiếu kết quả tiếng Hàn đầy thuật ngữ chuyên môn',
            'reality_item_3_point_2': 'Nội dung kết quả khó hiểu nếu chỉ dùng máy dịch',
            'reality_item_3_point_3': 'Khó phán đoán xem có cần khám chuyên sâu thêm không',
            'reality_item_3_point_4': 'Thiếu nơi để đặt câu hỏi về các thắc mắc trong kết quả',
            'reality_item_title_4': 'Thiếu sự chăm sóc sau khám',
            'reality_item_4_point_1': 'Thiếu hướng dẫn sức khỏe sau khi có kết quả xét nghiệm',
            'reality_item_4_point_2': 'Không có dịch vụ nhắc nhở cho kỳ khám sức khỏe tiếp theo',
            'reality_item_4_point_3': 'Hoang mang trong việc kết nối y tế khi phát hiện bất thường',
            'reality_item_4_point_4': 'Khó khăn trong việc quản lý dữ liệu sức khỏe liên tục',
            'reality_overtime_title': 'Thời gian không được quản lý đe dọa sức khỏe của bạn',
            'reality_overtime_p1': 'Bỏ lỡ lịch trình',
            'reality_overtime_p2': 'Nhịn ăn sai cách',
            'reality_overtime_p3': 'Hủy bỏ khám',
            'reality_overtime_p4': 'Lỗi giao tiếp',
            'reality_overtime_p5': 'Tai nạn khi khám',
            'reality_overtime_p6': 'Mức độ hiểu 0%',
            'reality_overtime_p7': 'Kết quả bị bỏ ngỏ',
            'reality_overtime_p8': 'Bỏ lỡ tái khám',
            'reality_overtime_p9': 'Bệnh trở nặng',
            'reality_overtime_p10': 'Bị cô lập y tế',
            'reality_overtime_p11': 'Khoảng trống xảy ra',
            'solution_title': 'Giải pháp do CHECKIT đề xuất',
            'solution_subtitle': 'Chúng tôi trở thành đối tác đáng tin cậy nhất của bạn trong mọi quy trình trừ hành vi y tế.',
            'individual_service1_title': 'Kết nối quản lý chuyên trách 1:1',
            'individual_service1_desc': 'Một quản lý chuyên nghiệp nói ngôn ngữ của bạn trực tiếp quản lý toàn bộ quá trình từ lựa chọn bệnh viện đến đặt hẹn.',
            'individual_service2_title_new': 'Hỗ trợ giao tiếp bằng văn bản thời gian thực',
            'individual_service2_desc_new': 'Vào ngày khám, chúng tôi hỗ trợ tất cả các giao tiếp trong bệnh viện qua văn bản thời gian thực để loại bỏ sự hỗn loạn.',
            'individual_service3_title_new': 'Cung cấp bản tóm tắt kết quả bằng tiếng mẹ đẻ',
            'individual_service3_desc_new': 'Chúng tôi tóm tắt các điểm chính của phiếu kết quả tiếng Hàn khó hiểu sang ngôn ngữ của bạn và gửi dưới dạng tệp.',
            'packages_title': 'Gói dịch vụ',
            'packages_subtitle': 'Hãy chọn mức độ hỗ trợ mà bạn thực sự cần.',
            'package1_title': 'Gói Chống Hỗn Loạn',
            'package1_price': '₩138,000',
            'package_includes': 'Bao gồm:',
            'package1_feature1': 'Tư vấn & Hỗ trợ lựa chọn bệnh viện',
            'package1_feature2': 'Đại diện đặt hẹn cuối cùng',
            'package1_feature3': 'Dịch các lưu ý trước khi khám',
            'package1_feature4': 'Hướng dẫn điền trước bảng câu hỏi',
            'package1_feature5': 'Hướng dẫn vị trí bệnh viện & chỗ đậu xe',
            'package1_feature6': '-',
            'package1_feature7': '-',
            'package1_feature8': '-',
            'package1_feature9': '-',
            'package_recommend_title': 'Được đề xuất cho:',
            'package1_recommend_desc': 'Những người chỉ muốn giải quyết những rắc rối của quy trình đặt hẹn',
            'package2_title': 'Gói Không Sai Sót',
            'package2_price': '₩276,000',
            'package2_includes': 'Bao gồm:',
            'package2_feature1': 'Tư vấn & Hỗ trợ lựa chọn bệnh viện',
            'package2_feature2': 'Đại diện đặt hẹn cuối cùng',
            'package2_feature3': 'Dịch các lưu ý trước khi khám',
            'package2_feature4': 'Hướng dẫn điền trước bảng câu hỏi',
            'package2_feature5': 'Hướng dẫn vị trí bệnh viện & chỗ đậu xe',
            'package2_feature6': 'Hỗ trợ văn bản thời gian thực vào ngày khám',
            'package2_feature7': 'Hướng dẫn cách nhận phiếu kết quả',
            'package2_feature8': '-',
            'package2_feature9': '-',
            'package2_recommend_desc': 'Những người lo lắng về việc giao tiếp trong bệnh viện vào ngày khám',
            'package3_title': 'Gói An Tâm Toàn Diện',
            'package3_price': '₩414,000',
            'package3_includes': 'Bao gồm:',
            'package3_feature1': 'Tư vấn & Hỗ trợ lựa chọn bệnh viện',
            'package3_feature2': 'Đại diện đặt hẹn cuối cùng',
            'package3_feature3': 'Dịch các lưu ý trước khi khám',
            'package3_feature4': 'Hướng dẫn điền trước bảng câu hỏi',
            'package3_feature5': 'Hướng dẫn vị trí bệnh viện & chỗ đậu xe',
            'package3_feature6': 'Hỗ trợ văn bản thời gian thực vào ngày khám',
            'package3_feature7': 'Hướng dẫn cách nhận phiếu kết quả',
            'package3_feature8': 'Dịch thuật đơn giản kết quả sang tiếng mẹ đẻ',
            'package3_feature9': 'Báo cáo tóm tắt nội dung chính của kết quả',
            'package3_feature10': 'Kiểm tra nhu cầu tái khám',
            'package3_feature11': 'Hỗ trợ yêu cầu cấp các giấy tờ bệnh viện',
            'package3_feature12': 'Thông báo cho kỳ khám sức khỏe tiếp theo',
            'package3_feature13': 'Tư vấn sức khỏe 1:1 Q&A (Phi y tế)',
            'package3_recommend_desc': 'Những người muốn được hỗ trợ hoàn hảo cho đến khi kiểm tra kết quả và chăm sóc sau khám',
            'options_title_new': 'Dịch vụ Tùy chọn',
            'option_card_title_1': 'Hướng dẫn Phi y tế',
            'option_card_price_1': '₩82,800',
            'option_card_desc_1': 'Hướng dẫn phi y tế về các mục kiểm tra, cấu trúc kết quả và quản lý sau khi khám.',
            'option_card_title_2': 'Hướng dẫn Đường đi trong Bệnh viện',
            'option_card_price_2': '₩27,600',
            'option_card_desc_2': 'Hiển thị đường đi chính xác và luồng di chuyển trong bệnh viện. Hữu ích cho khách truy cập lần đầu.',
            'option_card_title_3': 'Tùy chọn Thay đổi Đặt hẹn',
            'option_card_desc_3': 'Tùy chọn cho khách hàng cần thay đổi đặt chỗ sau khi đã đặt.',
            'option_card_3_item_1': 'Thay đổi 1 lần:',
            'option_card_3_item_2': 'Gói 2 lần thay đổi:',
            'option_card_3_item_3': 'Thay đổi không giới hạn:',
            'option_card_title_4': 'Yêu cầu Biên lai tiếng Anh',
            'option_card_price_4': '₩27,600',
            'option_card_desc_4': 'Yêu cầu biên lai tiếng Anh phù hợp cho mục đích bảo hiểm thay mặt cho bạn.',
            'option_card_title_5': 'Yêu cầu Kết quả CD',
            'option_card_price_5': '₩27,600',
            'option_card_desc_5': 'Yêu cầu đĩa CD kiểm tra hoặc các tệp hình ảnh bổ sung thay mặt cho bạn.',
            'option_card_title_6': 'Theo dõi Kết quả Khẩn cấp',
            'option_card_price_6': '₩27,600',
            'option_card_desc_6': 'Gửi một tin nhắn theo dõi khẩn cấp đến bệnh viện một lần.',
            'notice_title': 'Vui lòng Kiểm tra',
            'notice_subtitle': 'CHECKIT tuân thủ các luật lệ y tế.',
            'notice_quote': '“CHECKIT không phải là một tổ chức y tế và không tham gia vào các hành vi y tế (chẩn đoán, điều trị, kê đơn) hoặc lôi kéo/giới thiệu bệnh nhân.”',
            'notice_answer_title': 'CHECKIT làm gì?',
            'notice_answer_p1': 'Chúng tôi chỉ cung cấp các dịch vụ \'hỗ trợ hành chính phi y tế\' như đại diện đặt lịch hẹn bệnh viện, thông dịch và dịch thuật đơn giản phiếu kết quả.',
            'notice_answer_p2': 'Chúng tôi thực hiện vai trò của một \'đại diện giao tiếp\' thu thập và cung cấp thông tin từ quan điểm của bạn.',
            'notice_reality_title': 'Phán đoán y khoa là dành cho bác sĩ',
            'notice_reality_p1': 'Giải thích y khoa về kết quả xét nghiệm hoặc thiết lập hướng điều trị phải được tham khảo ý kiến của bác sĩ chuyên khoa tại cơ sở y tế liên quan. CHECKIT chỉ cung cấp bản dịch và tóm tắt đơn giản của văn bản trên phiếu kết quả.',
            'notice_situation_title': 'Vận hành Dịch vụ Độc lập',
            'notice_situation_p1': 'CHECKIT không được cấu trúc để nhận phí thông qua quan hệ đối tác với các bệnh viện cụ thể. Đây là một dịch vụ trả phí được vận hành độc lập chỉ vì sự thuận tiện của bạn.',
