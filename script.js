document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        en: {
            ...
            'corp_sec5_item4_title': 'Industrial Accident Prevention',
            'corp_sec5_item4_desc': 'By early detection of risk signals from check-up results and providing direct guidance in native languages, we prevent major industrial accidents in advance.',
        ...
        vn: {
            ...
            'corp_sec5_item4_title': 'Phòng ngừa Tai nạn Lao động',
            'corp_sec5_item4_desc': 'Phát hiện sớm các dấu hiệu nguy hiểm qua kết quả khám và hướng dẫn trực tiếp bằng tiếng mẹ đẻ cho người lao động, giúp ngăn ngừa trước các tai nạn nghiêm trọng.',
