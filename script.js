document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'why_us_title': '왜 CHECKIT 기업 보건관리 솔루션을 선택해야 할까요?',
            'why_us_subtitle_new': '복잡한 외국인 근로자 보건관리, 이제 단 하나의 플랫폼으로 스마트하게 해결하세요.',
            ...
            'why_us_feature2_desc': '의료 지식을 갖춘 전문 매니저가 근로자와 1:1로 소통하며, 예약부터 문진 안내까지 모든 비의료 과정을 대행합니다.',
        ...
        en: {
            ...
            'why_us_feature2_desc': 'Dedicated managers specialized in medical systems handle all non-medical processes from booking to questionnaires in the worker\'s native language.',
        ...
        cn: {
            ...
            'why_us_feature2_desc': '具备医学知识的专业经理与员工进行 1:1 沟通，代办从预约到问卷指导的所有非医疗流程。',
        ...
        vn: {
            ...
            'why_us_feature2_desc': 'Manager chuyên nghiệp có kiến thức y tế trao đổi 1:1 với lao động, thay mặt thực hiện tất cả quy trình phi y tế từ đặt lịch đến hướng dẫn phiếu khảo sát.',
