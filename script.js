document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'q1': '예약은 어떻게 하나요?', 'a1': 'CHECKIT 전담 매니저가 도와드립니다. 원하시는 검진 항목과 일정을 알려주시면, 조건에 맞는 최적의 병원을 추천해드리고 예약까지 한번에 진행해드립니다. \'지금 바로 상담 신청\' 버튼을 눌러 문의를 남겨주세요!',
            'q2': '병원/의료인과 계약된 구조인가요?', 'a2': '아닙니다. CHECKIT은 특정 병원과 계약 관계를 맺지 않습니다. 저희는 오직 고객님의 입장에서, 가장 적합한 병원을 객관적으로 추천하고 선택을 돕습니다. 고객님의 건강과 만족이 저희의 최우선 목표입니다.',
        ...
        en: {
            ...
            'chatbot_header': 'CHECKIT Bot', 'chatbot_placeholder': 'Type a message...', 'chatbot_greeting': 'Hello! Do you have any questions about CHECKIT? Please select a question below or type your own.',
            'q1': 'How do I make a reservation?', 'a1': 'Your dedicated CHECKIT manager will assist you. Just tell us your desired check-up items and schedule, and we will recommend the best hospitals that fit your criteria and handle the reservation for you. Click the \'Apply for a Consultation Now\' button to leave an inquiry!',
            'q2': 'Are you contracted with hospitals/medical staff?', 'a2': 'No. CHECKIT does not have contractual relationships with any specific hospitals. We objectively recommend and help you choose the most suitable hospital solely from your perspective. Your health and satisfaction are our top priorities.',
        ...
        cn: {
            ...
            'chatbot_header': 'CHECKIT Bot', 'chatbot_placeholder': '输入消息...', 'chatbot_greeting': '您好！对CHECKIT有什么疑问吗？请从下方选择问题或直接输入。',
            'q1': '如何预约？', 'a1': 'CHECKIT的专属经理将为您提供帮助。只需告诉我们您想要的检查项目和日程，我们将推荐最符合您条件的医院，并一次性完成预约。请点击\'立即申请咨询\'按钮留下您的问题！',
            'q2': '是否与医院/医务人员签订了合同？', 'a2': '不是的。CHECKIT不与任何特定医院签订合同。我们完全从您的立场出发，客观地推荐和帮助您选择最合适的医院。您的健康和满意是我们的首要目标。',
        ...
        vn: {
            ...
            'chatbot_header': 'CHECKIT Bot', 'chatbot_placeholder': 'Nhập tin nhắn...', 'chatbot_greeting': 'Xin chào! Bạn có câu hỏi nào về CHECKIT không? Vui lòng chọn một câu hỏi dưới đây hoặc tự nhập câu hỏi của bạn.',
            'q1': 'Làm cách nào để đặt lịch hẹn?', 'a1': 'Quản lý CHECKIT tận tâm của bạn sẽ hỗ trợ bạn. Chỉ cần cho chúng tôi biết các mục khám và lịch trình mong muốn của bạn, chúng tôi sẽ đề xuất các bệnh viện tốt nhất phù hợp với tiêu chí của bạn và xử lý việc đặt lịch hẹn cho bạn. Nhấp vào nút \'Đăng ký tư vấn ngay\' để để lại yêu cầu!',
            'q2': 'Bạn có hợp đồng với bệnh viện/nhân viên y tế không?', 'a2': 'Không. CHECKIT không có mối quan hệ hợp đồng với bất kỳ bệnh viện cụ thể nào. Chúng tôi khách quan đề xuất và giúp bạn chọn bệnh viện phù hợp nhất hoàn toàn từ góc độ của bạn. Sức khỏe và sự hài lòng của bạn là ưu tiên hàng đầu của chúng tôi.',
            ...
            'q5': 'Kết quả được gửi như thế nào?', 'a5': 'Sau khi bạn khám xong, chúng tôi sẽ nhận kết quả từ bệnh viện. Sau đó, chúng tôi sẽ dịch chúng sang ngôn ngữ mẹ đẻ của bạn và gửi chúng cho bạn một cách an toànพร้อมกับ lời giải thích chi tiết qua phương thức bạn muốn, chẳng hạn như email hoặc messenger. Bạn không còn phải lo lắng về các thuật ngữ y tế khó khăn nữa.',
