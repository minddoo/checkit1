document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        cn: {
            ...
            'q2': '是否与医院/医务人员签订了合同？',
            'a2': '不是的。CHECKIT不与任何特定医院签订合同。我们完全从您的立场出发，通过提供客观信息来帮助您选择最合适的医院。您的健康和满意是我们的首要目标。',
            'q3': '你们是否提供医疗行为或安排治疗？',
            'a3': '不，CHECKIT遵守医疗服务法，不进行任何医疗行为或安排治疗。我们是一项专注于\'非医疗过程\'的服务，如医院预约、口译和结果翻译，以帮助您专注于您的健康检查。',
            'q4': '体检当天能得到什么帮助？',
            'a4': '体检当天，Check Bot经理将全程陪伴您，让您不会因为语言障碍而感到孤单。我们为医院内的所有沟通环节（如挂号、问诊、缴费等）提供实时支持，帮助您舒适地专注于体检，而不会因语言问题感到不便或孤独。',
            'q5': '结果如何传递？',
        ...
        vn: {
            ...
            'a2': 'Không. CHECKIT không có mối quan hệ hợp đồng với bất kỳ bệnh viện cụ thể nào. Chúng tôi giúp bạn chọn bệnh viện phù hợp nhất một cách khách quan bằng cách cung cấp thông tin từ góc độ của bạn. Sức khỏe và sự hài lòng của bạn là ưu tiên hàng đầu của chúng tôi.',
            ...
            'a4': 'Vào ngày khám, quản lý của Check Bot sẽ đồng hành cùng bạn trong mọi khoảnh khắc để bạn không cảm thấy đơn độc vì rào cản ngôn ngữ. Chúng tôi hỗ trợ thời gian thực cho tất cả các quy trình giao tiếp trong bệnh viện như đăng ký, tư vấn và thanh toán, giúp bạn thoải mái tập trung vào việc khám sức khỏe mà không gặp phải sự bất tiện hay cô đơn do vấn đề ngôn ngữ.',
