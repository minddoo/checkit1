document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            'testimonial1_text': '“한국에서 건강검진은 처음이라 막막했는데, CHECKIT 덕분에 병원 선택부터 예약, 검진 당일 소통까지 정말 편하게 진행했어요. 결과지도 모국어로 설명해주셔서 이해가 쉬웠습니다.”', 'testimonial1_author': '안나, 유학생', 'testimonial1_type': '한국 거주 외국인',
            ...
            'testimonial3_text': '“외국인 직원들의 단체 건강검진이 항상 골치 아픈 업무였는데, CHECKIT 덕분에 예약부터 결과 관리까지 정말 간편해졌습니다. 직원들의 만족도도 매우 높아요.”', 'testimonial3_author': '박팀장, (주)글로벌테크', 'testimonial3_type': '기업 고객 담당자',
        ...
        en: {
            ...
            'testimonial1_text': '“It was my first time getting a health check-up in Korea, so I was at a loss, but thanks to CHECKIT, the process from hospital selection to reservation and communication on the day of the check-up was really comfortable. The results were also easy to understand as they were explained in my native language.”', 'testimonial1_author': 'Anna, International Student', 'testimonial1_type': 'Foreign Resident in Korea',
            ...
            'testimonial3_text': '“Group health check-ups for foreign employees were always a headache, but thanks to CHECKIT, everything from reservations to results management has become so simple. The employees are also very satisfied.”', 'testimonial3_author': 'Mr. Park, Global Tech Inc.', 'testimonial3_type': 'Corporate Client Manager',
        ...
        cn: {
            ...
            'testimonial1_text': '“这是我第一次在韩国做健康检查，本来很迷茫，但多亏了CHECKIT，从选择医院、预约到检查当天的沟通，一切都进行得非常顺利。结果报告也用我的母语进行了解释，很容易理解。”', 'testimonial1_author': '安娜，留学生', 'testimonial1_type': '居住在韩国的外国人',
            ...
            'testimonial3_text': '“为外国员工安排集体健康检查一直是一件头疼的事，但多亏了CHECKIT，从预约到结果管理都变得非常简单。员工们的满意度也非常高。”', 'testimonial3_author': '朴经理，Global Tech公司', 'testimonial3_type': '企业客户负责人',
