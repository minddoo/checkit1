document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        en: {
            ...
            'corporate_page_subtitle': 'Systematically managing foreign workers\' health<br>to increase productivity and reduce<br>the burden of health management.',
        ...
        vn: {
            ...
            'corporate_page_title': 'Giải pháp cho khách hàng doanh nghiệp',
            'corporate_page_subtitle': 'Quản lý sức khỏe nhân viên hệ thống<br>để tăng năng suất và giảm bớt<br>gánh nặng quản lý y tế.',
